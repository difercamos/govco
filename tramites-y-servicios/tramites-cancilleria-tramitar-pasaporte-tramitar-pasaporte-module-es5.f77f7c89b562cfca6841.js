...
var AvisoPrivacidadModalComponent = /** @class */ (function () {
    function AvisoPrivacidadModalComponent(tramiteService, activeModal) {
        this.tramiteService = tramiteService;
        this.activeModal = activeModal;
        this.getParams();
    }
    AvisoPrivacidadModalComponent.prototype.ngOnInit = function () {
    };
    AvisoPrivacidadModalComponent.prototype.getParams = function () {
        this.getTratamientoDatos();
    };
    AvisoPrivacidadModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    AvisoPrivacidadModalComponent.prototype.getTratamientoDatos = function () {
        var _this = this;
        this.tramiteService.getTratamientoDatos().subscribe(function (data) {
            if (data != undefined) {
                _this.messages = {
    ...
    AvisoPrivacidadModalComponent.ctorParameters = function () { return [
    ...
    return AvisoPrivacidadModalComponent;
}());
...
var AyudaPasaporteModalComponent = /** @class */ (function () {
    function AyudaPasaporteModalComponent(activeModal) {
        this.activeModal = activeModal;
    }
    AyudaPasaporteModalComponent.prototype.ngOnInit = function () {
    };
    AyudaPasaporteModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    AyudaPasaporteModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }
    ]; };
    ...
    return AyudaPasaporteModalComponent;
}());
...
var ComprobantePagoPseComponent = /** @class */ (function () {
    function ComprobantePagoPseComponent(tramiteService, router) {
        this.tramiteService = tramiteService;
        this.router = router;
        this.solictudId = this.router.snapshot.paramMap.get('ticketID');
    }
    ComprobantePagoPseComponent.prototype.ngOnInit = function () {
        this.getDataComprobante(this.solictudId);
    };
    ComprobantePagoPseComponent.prototype.getDataComprobante = function (solictudId) {
        var _this = this;
        this.tramiteService.getDataComprobante(solictudId).subscribe(function (data) {
            if (data != undefined) {
                _this.pdf = _this.base64ToArrayBuffer(data);
            }
        }, function (error) {
            console.error(error);
        });
    };
    ComprobantePagoPseComponent.prototype.base64ToArrayBuffer = function (base64) {
    ...
    ComprobantePagoPseComponent.ctorParameters = function () { return [
        { type: _services_tramitar_pasaporte_service__WEBPACK_IMPORTED_MODULE_3__["TramitarPasaporteService"] },
    ...
    return ComprobantePagoPseComponent;
}());
...
var ConsultarEstadoForm = /** @class */ (function () {
    function ConsultarEstadoForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    ConsultarEstadoForm.prototype.buildForm = function () {
    ...
    ConsultarEstadoForm.prototype.getForm = function () {
        return this.form;
    };
    ConsultarEstadoForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    ConsultarEstadoForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return ConsultarEstadoForm;
}());
...
var ConsultarEstadoComponent = /** @class */ (function () {
    function ConsultarEstadoComponent(tramiteService, router) {
        this.tramiteService = tramiteService;
        this.router = router;
    ...
    ConsultarEstadoComponent.prototype.ngOnInit = function () {
    };
    ConsultarEstadoComponent.prototype.buildForm = function () {
        this.consultarEstado = this.ConsultarEstadoForm.getForm();
        this.setStep("2");
    };
    ConsultarEstadoComponent.prototype.getParams = function () {
        this.getTipoDocumento();
    };
    ConsultarEstadoComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('step', step);
    };
    ConsultarEstadoComponent.prototype.getTipoDocumento = function () {
        var _this = this;
        this.tramiteService.getTiposDocumento().subscribe(function (data) {
            if (data != undefined && data.length > 0) {
                _this.listTipoDocumento = data;
            }
        }, function (error) {
            console.error(error);
        });
    };
    ConsultarEstadoComponent.prototype.consultar = function () {
        var _this = this;
        ...
        this.tramiteService.getDataSolicitud(this.dataConsultaSolicitudModel).subscribe(function (data) {
            if (data.return != undefined) {
                _this.router.navigate(["/cancilleria/estadoSolicitud", data.return.nombres, data.return.tipoTramite, "Cédula de ciudadania", data.return.numeroSolicitud, data.return.numeroDocumento, data.return.oficinaExpedidora, data.return.textoEstadoActual, data.return.estadoActual]);
            }
            else {
                _this.failConsulta = true;
                _this.currentMessage.title = 'Lo sentimos';
                _this.currentMessage.type = 'error';
                _this.currentMessage.message = 'Los datos ingresados son incorrectos, te recomendamos:\n';
                _this.currentMessage.message += '1. revise que los datos ingresados sean los solicitados';
            }
        }, function (error) {
            _this.failConsulta = true;
            _this.currentMessage.title = 'Lo sentimos';
    ...
    ConsultarEstadoComponent.prototype.ceroIzquierda = function (cadena, longitud) {
        for (var i = cadena.length; i < longitud; i++) {
            cadena = "0" + cadena;
        }
        return cadena;
    };
    ConsultarEstadoComponent.prototype.regresar = function () {
        debugger;
        this.findInvalidControls();
        this.submitted = true;
        if (!this.ConsultarEstadoForm.isValid()) {
    ...
    ConsultarEstadoComponent.prototype.findInvalidControls = function () {
        var invalid = [];
        var controls = this.consultarEstado.controls;
        for (var name_1 in controls) {
            if (controls[name_1].invalid) {
                console.error(name_1);
            }
        }
        return invalid;
    };
    Object.defineProperty(ConsultarEstadoComponent.prototype, "f", {
        get: function () { return this.consultarEstado.controls; },
        enumerable: true,
        configurable: true
    });
    ConsultarEstadoComponent.ctorParameters = function () { return [
        { type: _services_tramitar_pasaporte_service__WEBPACK_IMPORTED_MODULE_3__["TramitarPasaporteService"] },
    ...
    return ConsultarEstadoComponent;
}());
...
var ContainerPasaporteComponent = /** @class */ (function () {
    function ContainerPasaporteComponent() {
    }
    ContainerPasaporteComponent.prototype.ngOnInit = function () {
    };
    ...
    return ContainerPasaporteComponent;
}());
...
var EstadoSolicitudForm = /** @class */ (function () {
    function EstadoSolicitudForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    EstadoSolicitudForm.prototype.buildForm = function () {
    };
    EstadoSolicitudForm.prototype.getForm = function () {
        return this.estadoSolicitudForm;
    };
    EstadoSolicitudForm.prototype.getFormValues = function () {
        return this.estadoSolicitudForm.value;
    };
    return EstadoSolicitudForm;
}());
...
var EstadoSolicitudComponent = /** @class */ (function () {
    function EstadoSolicitudComponent(router) {
        this.router = router;
    ...
    EstadoSolicitudComponent.prototype.homologarEstado = function (estado) {
        var srcEstadoh = "";
    ...
    EstadoSolicitudComponent.prototype.buildForm = function () {
        this.estadoSolicitudForm = this.EstadoSolicitudForm.getForm();
        this.setStep("4");
    };
    EstadoSolicitudComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('step', step);
    };
    EstadoSolicitudComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] }
    ]; };
...
var IngresarTramiteComponent = /** @class */ (function () {
    function IngresarTramiteComponent(route) {
        this.route = route;
        this.setStep("2");
    }
    IngresarTramiteComponent.prototype.ngOnInit = function () {
    };
    IngresarTramiteComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('step', step);
    };
    IngresarTramiteComponent.prototype.Consultar = function () {
        this.route.navigate(["/cancilleria/consultarEstado"]);
    };
    IngresarTramiteComponent.prototype.Solicitar = function () {
...
var PagarPasaporteForm = /** @class */ (function () {
    function PagarPasaporteForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    PagarPasaporteForm.prototype.buildForm = function () {
    ...
    PagarPasaporteForm.prototype.getForm = function () {
        return this.pagoPasaporteForm;
    };
    PagarPasaporteForm.prototype.getFormValues = function () {
        return this.pagoPasaporteForm.value;
    };
    return PagarPasaporteForm;
}());
...
var PagarPasaporteComponent = /** @class */ (function () {
    function PagarPasaporteComponent(route, sanitizer, router) {
        var _this = this;
        this.route = route;
        ...
        this.centavos = ".00";
        data.return.outFormaPago.forEach(function (element) {
            var dataPay;
            dataPay = {
    ...
    PagarPasaporteComponent.prototype.ngOnInit = function () {
    };
    PagarPasaporteComponent.prototype.buildForm = function () {
    ...
    PagarPasaporteComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('step', step);
    };
    PagarPasaporteComponent.prototype.pagoEnLinea = function (type, url) {
        if (type === "PSE") {
    ...
    PagarPasaporteComponent.prototype.verMas = function () {
    ...
    PagarPasaporteComponent.ctorParameters = function () { return [
    ...
    return PagarPasaporteComponent;
}());
...
var PagoOnlineComponent = /** @class */ (function () {
    function PagoOnlineComponent(router, sanitizer, route) {
        this.router = router;
        this.sanitizer = sanitizer;
        this.route = route;
    ...
    PagoOnlineComponent.prototype.validarSrc = function () {
    ...
    PagoOnlineComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
...
var SolicitarPasaporteForm = /** @class */ (function () {
    function SolicitarPasaporteForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    SolicitarPasaporteForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
            tipoDocumento: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(20)])],
            numeroDocumento: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required],
    ...
    SolicitarPasaporteForm.prototype.getForm = function () {
        return this.form;
    };
    SolicitarPasaporteForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    SolicitarPasaporteForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return SolicitarPasaporteForm;
}());
...
var SolicitarPasaporteComponent = /** @class */ (function () {
    function SolicitarPasaporteComponent(tramiteService, modalService, modalNotificationService, router) {
        this.tramiteService = tramiteService;
    ...
    SolicitarPasaporteComponent.prototype.ngOnInit = function () {
    };
    SolicitarPasaporteComponent.prototype.buildForm = function () {
        this.solicitudPasaporteForm = this.SolicitarPasaporteForm.getForm();
        this.setStep("2");
    };
    SolicitarPasaporteComponent.prototype.getParams = function () {
        this.getTipoDocumento();
    ...
    SolicitarPasaporteComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('step', step);
    };
    SolicitarPasaporteComponent.prototype.changeTipoPasaporte = function () {
        var _this = this;
        this.solicitudPasaporteForm.get('tipoPasaporte').valueChanges.subscribe(function (tipoPasaporte) {
            _this.solicitudPasaporteForm.get("motivoSolicitud").setValue('');
            _this.solicitudPasaporteForm.get("motivoSolicitud").enable();
            _this.getMotivosSolicitud(Number(tipoPasaporte.value));
        });
    };
    SolicitarPasaporteComponent.prototype.getListadoOficinas = function () {
        var _this = this;
        this.tramiteService.getListadoOficinas().subscribe(function (data) {
            if (data != undefined && data.length > 0) {
                _this.listOficinas = data;
            }
        }, function (error) {
            console.error(error);
        });
    };
    SolicitarPasaporteComponent.prototype.getTipoDocumento = function () {
        var _this = this;
        this.tramiteService.getTiposDocumento().subscribe(function (data) {
    ...
    SolicitarPasaporteComponent.prototype.getTipoPasaporte = function () {
        var _this = this;
        this.tramiteService.getTiposPasaporte().subscribe(function (data) {
            if (data != undefined && data.length > 0) {
                _this.listTipoPasaporte = data;
            }
        }, function (error) {
            console.error(error);
        });
    };
    SolicitarPasaporteComponent.prototype.getMotivosSolicitud = function (tipoPasaporte) {
        var _this = this;
        this.tramiteService.getMotivosSolicitud(tipoPasaporte).subscribe(function (data) {
            if (data != undefined && data.length > 0) {
                _this.listMotivoSolicitud = data;
                _this.solicitudPasaporteForm.get("motivoSolicitud").enable();
            }
        }, function (error) {
            console.error(error);
    ...
    SolicitarPasaporteComponent.prototype.save = function () {
        var _this = this;
        this.findInvalidControls();
        this.submitted = true;
        ...
        this.tramiteService.insSolicitudPasaporte(this.dataSolicitudPasaporteModel).subscribe(function (data) {
            var result = JSON.parse(data);
            if (result.return != null) {
                if (result.return.outDetalleRespuesta.codigo !== 1) {
                    _this.modalNotificationService.openNotificationDialog("Error", result.return.outDetalleRespuesta.mensaje, "error", function () {
                        return;
                    });
                }
                else {
                    _this.modalNotificationService.openNotificationDialog("Guardado", result.return.outDetalleRespuesta.mensaje, "success", function () {
                        _this.router.navigate(["/cancilleria/pagarPasaporte", data]);
                    });
                }
            }
        }, function (error) {
    ...
    SolicitarPasaporteComponent.prototype.showAvisoPrivacidad = function () {
    ...
    SolicitarPasaporteComponent.prototype.showAyuda = function () {
    ...
    SolicitarPasaporteComponent.prototype.clean = function () {
    ...
    SolicitarPasaporteComponent.prototype.resetForm = function () {
        this.solicitudPasaporteForm.reset();
        this.invalidForm = false;
    };
    SolicitarPasaporteComponent.prototype.getTratamientoDatos = function () {
        var _this = this;
        this.tramiteService.getTratamientoDatos().subscribe(function (data) {
            if (data != undefined && data != null) {
                _this.mensajeTratamiento = data["return"].mensajeTratamiento;
                _this.mensajeConsentimiento = data["return"].mensajeConsentimiento;
                _this.mensajeAvisoInicial = data["return"].mensajeAviso.substring(0, data["return"].mensajeAviso.indexOf("{"));
                _this.mensajeAvisoFinal = data["return"].mensajeAviso.substring(data["return"].mensajeAviso.indexOf("}") + 1);
            }
        }, function (error) {
            console.error(error);
        });
    };
    SolicitarPasaporteComponent.prototype.findInvalidControls = function () {
        var invalid = [];
        var controls = this.solicitudPasaporteForm.controls;
        for (var name_1 in controls) {
            if (controls[name_1].invalid) {
                console.error(name_1);
            }
    ...
    Object.defineProperty(SolicitarPasaporteComponent.prototype, "f", {
        get: function () { return this.solicitudPasaporteForm.controls; },
        enumerable: true,
        configurable: true
    });
    SolicitarPasaporteComponent.ctorParameters = function () { return [
    ...
    return SolicitarPasaporteComponent;
}());
...
var VerSolicitudPasaporteForm = /** @class */ (function () {
    function VerSolicitudPasaporteForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    VerSolicitudPasaporteForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
            tipoDocumento: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].min(1), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].max(20)])],
            numeroDocumento: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required],
            fechaExpedicion: ['', _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].compose([_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required, _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].minLength(10), _angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].maxLength(10)])],
    ...
    VerSolicitudPasaporteForm.prototype.getForm = function () {
        return this.form;
    };
    VerSolicitudPasaporteForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    VerSolicitudPasaporteForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return VerSolicitudPasaporteForm;
}());
...
var VerSolicitudPasaporteComponent = /** @class */ (function () {
    function VerSolicitudPasaporteComponent(modalService, modalNotificationService, router) {
        this.modalService = modalService;
        this.modalNotificationService = modalNotificationService;
        this.router = router;
        this.invalidForm = false;
    ...
    VerSolicitudPasaporteComponent.prototype.ngOnInit = function () {
    };
    VerSolicitudPasaporteComponent.prototype.buildForm = function () {
        this.verSolicitudPasaporteForm = this.VerSolicitudPasaporteForm.getForm();
    };
    VerSolicitudPasaporteComponent.prototype.showAyuda = function () {
    ...
    VerSolicitudPasaporteComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] },
        { type: _shared_dialog_modal_services_confirm_modal_service__WEBPACK_IMPORTED_MODULE_4__["ConfirmModalService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] }
    ]; };
    ...
    return VerSolicitudPasaporteComponent;
}());
...
var TramitarPasaporteService = /** @class */ (function () {
    function TramitarPasaporteService(http) {
        this.http = http;
        this.urlTramite = {
    ...
    TramitarPasaporteService.prototype.getTiposDocumento = function () {
    ...
    TramitarPasaporteService.prototype.getTiposPasaporte = function () {
        return this.http.get(this.urlTramite.tiposPasaporte, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().append("angular-show-loading", "true")
        });
    };
    TramitarPasaporteService.prototype.getListadoOficinas = function () {
        return this.http.get(this.urlTramite.listadoOficinas, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().append("angular-show-loading", "true")
        });
    };
    TramitarPasaporteService.prototype.getMotivosSolicitud = function (tipoPasaporte) {
        var url = this.urlTramite.motivosSolicitud + tipoPasaporte;
        return this.http.get(url, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().append("angular-show-loading", "true")
        });
    };
    TramitarPasaporteService.prototype.getTratamientoDatos = function () {
        return this.http.get(this.urlTramite.tratamientoDatos, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().append("angular-show-loading", "true")
        });
    };
    TramitarPasaporteService.prototype.insSolicitudPasaporte = function (modelSolicitud) {
    ...
    TramitarPasaporteService.prototype.getDataComprobante = function (solicitudId) {
        var url = this.urlTramite.dataComprobante + solicitudId;
        return this.http.post(url, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().append("angular-show-loading", "true")
        });
    };
    TramitarPasaporteService.prototype.getDataSolicitud = function (modelConsulta) {
        return this.http.post(this.urlTramite.consultaSolicitud, modelConsulta, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().append('Content-Type', 'application/json').append('angular-show-loading', 'true')
        });
    };
    TramitarPasaporteService.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"] }
    ]; };
    return TramitarPasaporteService;
}());
...
var TramitarPasaporteRoutingModule = /** @class */ (function () {
    function TramitarPasaporteRoutingModule() {
    }
    ...
    return TramitarPasaporteRoutingModule;
}());
...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm5/ng-recaptcha.js");
...
var TramitarPasaporteModule = /** @class */ (function () {
    function TramitarPasaporteModule() {
    }
    ...
    return TramitarPasaporteModule;
}());
...
//# sourceMappingURL=tramites-cancilleria-tramitar-pasaporte-tramitar-pasaporte-module-es5.f77f7c89b562cfca6841.js.map