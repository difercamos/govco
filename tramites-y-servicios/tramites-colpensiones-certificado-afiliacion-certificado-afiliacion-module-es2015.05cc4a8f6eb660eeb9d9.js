...
let CertificadoAfiliacionRoutingModule = class CertificadoAfiliacionRoutingModule {
};
...
let CertificadoAfiliacionModule = class CertificadoAfiliacionModule {
};
...
let CertificadoAfiliacionComponent = class CertificadoAfiliacionComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let DescargarComponent = class DescargarComponent {
    constructor(fb, certificadoAfiliacionUtils) {
        this.fb = fb;
...
DescargarComponent.ctorParameters = () => [
...
let CertificadoAfiliacionUtilsService = class CertificadoAfiliacionUtilsService {
    constructor(http) {
        this.http = http;
        this.urlTramite = {
...
CertificadoAfiliacionUtilsService.ctorParameters = () => [
...
//# sourceMappingURL=tramites-colpensiones-certificado-afiliacion-certificado-afiliacion-module-es2015.05cc4a8f6eb660eeb9d9.js.map