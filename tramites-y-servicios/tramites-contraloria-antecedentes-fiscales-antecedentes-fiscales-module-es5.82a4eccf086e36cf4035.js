...
var AntecedentesFiscalesRoutingModule = /** @class */ (function () {
    function AntecedentesFiscalesRoutingModule() {
    }
    ...
    return AntecedentesFiscalesRoutingModule;
}());
...
var AntecedentesFiscalesModule = /** @class */ (function () {
    function AntecedentesFiscalesModule() {
    }
    ...
    return AntecedentesFiscalesModule;
}());
...
var AntecedentesFiscalesComponent = /** @class */ (function () {
    function AntecedentesFiscalesComponent(pageTitle) {
        this.pageTitle = pageTitle;
    }
    AntecedentesFiscalesComponent.prototype.ngOnInit = function () {
        this.setPageTitle();
    };
    AntecedentesFiscalesComponent.prototype.setPageTitle = function () {
        var baseTitle = _stringResources_app_strings_json__WEBPACK_IMPORTED_MODULE_2__["page-title"];
        var tramiteTitle = _stringResources_app_strings_json__WEBPACK_IMPORTED_MODULE_2__.tramites.contraloria["antecedentes-fiscales"].title;
        this.pageTitle.setTitle(baseTitle + "-" + tramiteTitle);
    };
    AntecedentesFiscalesComponent.ctorParameters = function () { return [
    ...
    return AntecedentesFiscalesComponent;
}());
...
var BuscarAntecedentesForm = /** @class */ (function () {
    function BuscarAntecedentesForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    BuscarAntecedentesForm.prototype.buildForm = function () {
    ...
    BuscarAntecedentesForm.prototype.getForm = function () {
        return this.form;
    };
    BuscarAntecedentesForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    BuscarAntecedentesForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return BuscarAntecedentesForm;
}());
...
var BuscarAntecedentesComponent = /** @class */ (function () {
    function BuscarAntecedentesComponent(service, recaptchaService) {
    ...
    BuscarAntecedentesComponent.prototype.ngOnInit = function () {
    ...
    BuscarAntecedentesComponent.prototype.ngAfterViewInit = function () {
        this.getDataForm();
    };
    BuscarAntecedentesComponent.prototype.getDataForm = function () {
        var _this = this;
        this.service.getTiposDocumento()
            .subscribe(function (data) {
            if (data.length > 0) {
                _this.tiposDocumento = data;
            }
        }, function (error) {
            console.error(error);
        });
    };
    BuscarAntecedentesComponent.prototype.search = function () {
        var _this = this;
        ...
        this.invalidForm = false;
        var formValues = this.formItem.getFormValues();
        this.recaptchaService.validateServerKey(formValues.recaptcha).subscribe(function (data) {
            if (data["success"] === true) {
                _this.queryCertificados(formValues.documento, formValues.tipoDocumento.value);
            }
            else {
    ...
    BuscarAntecedentesComponent.prototype.queryCertificados = function (documento, tipoDocumento) {
        var _this = this;
        this.service.GetCertificado({
            documento: documento,
            tipoDocumento: tipoDocumento
        }).subscribe(function (data) {
            _this.showMessage("success", _this.messages.success);
            _this.handleFileView(data, documento);
            _this.setTramiteStep("4");
            _this.form.get('recaptcha').setValue(null);
        }, function (error) {
            _this.showMessage("error", _this.messages.errorRequest);
            _this.form.get('recaptcha').setValue(null);
        });
    };
    //Muestra el archivo de acuerdo al tipo de navegador (descarga el archivo cuando es IE)
    BuscarAntecedentesComponent.prototype.handleFileView = function (data, documento) {
    ...
    BuscarAntecedentesComponent.prototype.isIE = function () {
    ...
    BuscarAntecedentesComponent.prototype.setTramiteStep = function (step) {
    ...
    BuscarAntecedentesComponent.prototype.showMessage = function (type, message) {
    ...
    BuscarAntecedentesComponent.ctorParameters = function () { return [
    ...
    return BuscarAntecedentesComponent;
}());
...
var AntecedentesFiscalesService = /** @class */ (function () {
    function AntecedentesFiscalesService(http) {
        this.http = http;
        this.urlTramite = {
    ...
    AntecedentesFiscalesService.prototype.getTiposDocumento = function () {
    ...
    AntecedentesFiscalesService.prototype.GetCertificado = function (datosPersonales) {
    ...
    AntecedentesFiscalesService.ctorParameters = function () { return [
    ...
    return AntecedentesFiscalesService;
}());
...
//# sourceMappingURL=tramites-contraloria-antecedentes-fiscales-antecedentes-fiscales-module-es5.82a4eccf086e36cf4035.js.map