...
let ObtenerCopiaComponent = class ObtenerCopiaComponent {
    constructor(service) {
    ...
    search() {
        ...
        if (!this.formObtenerCopia.isValid()) {
            ...
            this.service.GetCertificado(this.dataGenerar)
                ...
                this.titulo = _stringResources_tramites_obtener_copia_rut_json__WEBPACK_IMPORTED_MODULE_4__.messages["200generarCertificado"];
                this.mensajeAlerta = '';
                this.setStep('4');
            }, (error) => {
                if (error.status == 404) {
                    ...
                    this.tipoAlerta = 'error';
                    this.titulo = 'Lo sentimos';
                    this.mensajeAlerta = _stringResources_tramites_obtener_copia_rut_json__WEBPACK_IMPORTED_MODULE_4__.messages["404generarCertificado"];
                }
                else {
                    this.mostrarAlerta = true;
                    this.tipoAlerta = 'error';
                    this.titulo = 'Lo sentimos';
                    this.mensajeAlerta = _stringResources_tramites_obtener_copia_rut_json__WEBPACK_IMPORTED_MODULE_4__.messages["0generarCertificado"];
                }
                this.setStep('2');
            });
        }
...
ObtenerCopiaComponent.ctorParameters = () => [
...
let RutRoutingModule = class RutRoutingModule {
};
...
//# sourceMappingURL=tramites-dian-rut-rut-module-es2015.94d913ef038344398c1d.js.map