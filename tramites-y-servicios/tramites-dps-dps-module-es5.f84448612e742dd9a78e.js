...
var DpsComponent = /** @class */ (function () {
    function DpsComponent(dpsUtilsService) {
        this.dpsUtilsService = dpsUtilsService;
        this.formDps = new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormGroup"]({
            firstName: new _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormControl"]()
        });
    }
    DpsComponent.prototype.ngOnInit = function () {
    };
    DpsComponent.ctorParameters = function () { return [
...
var OpcionesDpsComponent = /** @class */ (function () {
    function OpcionesDpsComponent(modalService) {
    ...
    OpcionesDpsComponent.prototype.ngOnInit = function () {
    };
    OpcionesDpsComponent.prototype.search = function () {
    };
    OpcionesDpsComponent.prototype.reset = function () {
        this.showError('0');
        this.changeSuccess(false);
    };
    OpcionesDpsComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('steptramites', step);
    };
    OpcionesDpsComponent.prototype.changeValue = function () {
        this.reset();
        this.setStep("2");
    };
    OpcionesDpsComponent.prototype.showError = function (codigoError) {
    ...
    OpcionesDpsComponent.prototype.changeSuccess = function (activo) {
        this.activoMensajeSuccess = activo;
        this.activoMensajeSuccessValidado = false;
    };
    OpcionesDpsComponent.prototype.changeSuccessValidado = function (activo) {
        this.activoMensajeSuccessValidado = activo;
        this.activoMensajeSuccess = false;
    };
    OpcionesDpsComponent.ctorParameters = function () { return [
...
var VerificarFormComponent = /** @class */ (function () {
    function VerificarFormComponent(dpsUtilsService, router) {
        this.dpsUtilsService = dpsUtilsService;
        this.router = router;
    ...
    VerificarFormComponent.prototype.ngOnInit = function () {
    ...
    VerificarFormComponent.prototype.onKeyValidNumber = function (event) {
        var e = event;
    ...
    VerificarFormComponent.prototype.sendMessage = function () {
        this.mensajeError.emit('3');
    };
    VerificarFormComponent.prototype.showMensajeSuccess = function (activo) {
        this.showSuccess.emit(activo);
    };
    VerificarFormComponent.prototype.reset = function () {
        this.invalidForm = false;
        this.mensajeError.emit('0');
        this.showMensajeSuccess(false);
    };
    VerificarFormComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('steptramites', step);
    };
    VerificarFormComponent.prototype.changeValue = function (event) {
        console.log(event);
        /// this.onKeyValidNumber(event);
        this.reset();
        this.setStep("2");
    };
    VerificarFormComponent.prototype.search = function () {
        var _this = this;
        this.invalidForm = false;
        ...
        this.dpsUtilsService.sendVerificacion(this.form.value).subscribe(function (response) {
            _this.setStep("4");
    ...
    VerificarFormComponent.ctorParameters = function () { return [
...
var VerificarForm = /** @class */ (function () {
    ...
    VerificarForm.prototype.getForm = function () {
        return this.form;
    };
    VerificarForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    VerificarForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return VerificarForm;
}());
...
var VinculacionFormComponent = /** @class */ (function () {
    function VinculacionFormComponent(dpsUtilsService, router) {
        this.dpsUtilsService = dpsUtilsService;
        this.router = router;
        this.mensajeError = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
        this.showSuccess = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    ...
    VinculacionFormComponent.prototype.sendMessage = function () {
        this.mensajeError.emit('2');
    };
    VinculacionFormComponent.prototype.showMensajeSuccess = function (activo) {
        this.showSuccess.emit(activo);
    };
    VinculacionFormComponent.prototype.ngOnInit = function () {
    ...
    VinculacionFormComponent.prototype.reset = function () {
        this.invalidForm = false;
        this.mensajeError.emit('0');
        this.showMensajeSuccess(false);
    };
    VinculacionFormComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('steptramites', step);
    };
    VinculacionFormComponent.prototype.changeValue = function () {
        this.reset();
        this.setStep("2");
    };
    VinculacionFormComponent.prototype.onKeyValidNumber = function (event) {
        var e = event;
        var ch = String.fromCharCode(e.keyCode);
        var regEx = new RegExp('^[0-9]*$');
        console.log(e.keyCode);
    ...
    VinculacionFormComponent.prototype.search = function () {
        var _this = this;
        this.invalidForm = false;
        this.mensajeError.emit('0');
        this.invalidTipoDocumento = false;
        ...
        this.dpsUtilsService.sendVinculacion(this.form.value).subscribe(function (response) {
            var blob = new Blob([response], { type: 'application/pdf' });
            if (navigator.msSaveBlob) { // For ie and Edge
    ...
    VinculacionFormComponent.ctorParameters = function () { return [
    ...
    return VinculacionFormComponent;
}());
...
var VinculacionForm = /** @class */ (function () {
    function VinculacionForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    VinculacionForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
    ...
    VinculacionForm.prototype.getForm = function () {
        return this.form;
    };
    VinculacionForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    VinculacionForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return VinculacionForm;
}());
...
var DpsRoutingModule = /** @class */ (function () {
    function DpsRoutingModule() {
    }
...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm5/ng-recaptcha.js");
...
var DpsUtilsService = /** @class */ (function () {
    function DpsUtilsService(http) {
        this.http = http;
        this.url = 'http://localhost:8081/';
    }
    DpsUtilsService.prototype.sendVerificarDps = function (datosVerificar) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('documento', datosVerificar.documento);
        return this.http
            .get("ConsultaCertiunidos/ObtenerPersonaUnidosPorCodigoVerificacion", { params: params })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler));
    };
    DpsUtilsService.prototype.sendVinculacion = function (datosVinculacion) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set('numeroDocumento', datosVinculacion.documento)
        ...
        return this.http
            .get("Dps/Vinculacion", { headers: headers, params: params, responseType: "blob" })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler));
    };
    DpsUtilsService.prototype.sendVerificacion = function (datosVerificar) {
        var params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]()
            .set('codigoVerificacion', datosVerificar.documento);
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/json")
            .append("angular-show-loading", "true");
        return this.http
            .get("Dps/Verificacion", { headers: headers, params: params, responseType: "blob" })
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.errorHandler));
    };
    DpsUtilsService.prototype.errorHandler = function (error) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(error);
    };
    DpsUtilsService.prototype.getTiposDocumento = function () {
        return [
    ...
    DpsUtilsService.ctorParameters = function () { return [
...
//# sourceMappingURL=tramites-dps-dps-module-es5.f84448612e742dd9a78e.js.map