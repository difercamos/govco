...
var AccionDocumentoComponent = /** @class */ (function () {
    function AccionDocumentoComponent() {
    }
    AccionDocumentoComponent.prototype.ngOnInit = function () {
    };
    ...
    return AccionDocumentoComponent;
}());
...
var AccionExcepcionComponent = /** @class */ (function () {
    function AccionExcepcionComponent() {
    }
    AccionExcepcionComponent.prototype.ngOnInit = function () {
    };
    ...
    return AccionExcepcionComponent;
}());
...
var AccionFormularioComponent = /** @class */ (function () {
    function AccionFormularioComponent() {
    }
    AccionFormularioComponent.prototype.ngOnInit = function () {
    };
    ...
    return AccionFormularioComponent;
}());
...
var AccionPagoComponent = /** @class */ (function () {
    function AccionPagoComponent() {
    }
    AccionPagoComponent.prototype.ngOnInit = function () {
    };
...
var AccionSolicitudComponent = /** @class */ (function () {
    function AccionSolicitudComponent() {
    }
    AccionSolicitudComponent.prototype.ngOnInit = function () {
    ...
    return AccionSolicitudComponent;
}());
...
var AccionVerificacionComponent = /** @class */ (function () {
    function AccionVerificacionComponent() {
    }
    AccionVerificacionComponent.prototype.ngOnInit = function () {
        console.log(this.data);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return AccionVerificacionComponent;
}());
...
var EmbebidosComponent = /** @class */ (function () {
    function EmbebidosComponent(sanitizer, modalService) {
        this.sanitizer = sanitizer;
        this.modalService = modalService;
    }
    EmbebidosComponent.prototype.ngAfterViewInit = function () {
    };
    EmbebidosComponent.prototype.showModal = function (id) {
        var modal = this.modalService.open(_recursos_modal_recursos_modal_component__WEBPACK_IMPORTED_MODULE_4__["RecursosModalComponent"], { size: 'lg',
            backdrop: "static",
            keyboard: false
        });
        modal.componentInstance.idTramite = id;
    };
    EmbebidosComponent.prototype.ngAfterViewChecked = function () {
        this.setNumeroTramite(this.data["NUMERO"]);
    };
    EmbebidosComponent.prototype.setNumeroTramite = function (numero) {
        var s = document.getElementsByTagName('govco-area-servicios');
        if (s.length > 0) {
            s[0].setAttribute('itemid', "T" + numero);
        }
    };
    EmbebidosComponent.ctorParameters = function () { return [
...
var FichaespecificaAccordionComponent = /** @class */ (function () {
    function FichaespecificaAccordionComponent() {
    ...
    FichaespecificaAccordionComponent.prototype.ngOnInit = function () {
    };
    FichaespecificaAccordionComponent.prototype.eventoTabAudiencia = function (data) {
        this.cargarMomentosAudiencia.emit(data);
    };
    FichaespecificaAccordionComponent.prototype.dataDetalleMomentoAudiencia = function (audiencia, momento) {
        var data = {
            audiencia: audiencia,
            momento: momento
        };
    ...
    return FichaespecificaAccordionComponent;
}());
...
var FichaespecificaHeaderComponent = /** @class */ (function () {
    function FichaespecificaHeaderComponent() {
    }
    FichaespecificaHeaderComponent.prototype.ngOnInit = function () {
        console.log(this.data);
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
    ...
    return FichaespecificaHeaderComponent;
}());
...
var FichaEspecificaComponent = /** @class */ (function () {
    function FichaEspecificaComponent(fichaTramiteService, modalService) {
    ...
    FichaEspecificaComponent.prototype.ngOnInit = function () {
        this.loadDataInfoFicha(this.informacionFicha);
    };
    FichaEspecificaComponent.prototype.loadDataInfoFicha = function (dataTramite) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this.fichaTramiteService.GetTipoTramiteFichaEspecificaById(dataTramite.id).subscribe(function (dataFicha) {
                    _this.infoBasicaTramite = dataFicha;
                    _this.fichaTramiteService.GetTiposAudienciaById(dataTramite.id).subscribe(function (n) {
                        _this.audiencias = n;
                        if (_this.audiencias.length > 0) {
                            _this.loadMomentosAutiencia(dataTramite.id, _this.audiencias[0].detalle);
                        }
                    });
                });
                return [2 /*return*/];
    ...
    FichaEspecificaComponent.prototype.cargarDetalleMomento = function (data) {
        var _this = this;
        this.fichaTramiteService.GetDataFichaByIdAudiencia(this.informacionFicha.id, data.audiencia, data.momento)
            .subscribe(function (dataAccion) {
            dataAccion.forEach(function (element) {
                _this.audiencias.forEach(function (item) {
                    if (item.detalle === data.audiencia) {
                        item.momentos.forEach(function (i) {
                            if (i.Orden === data.momento) {
                                i.acciones = _this.procesarDataAcciones(dataAccion);
                            }
                        });
                    }
                });
            });
            console.log(_this.audiencias);
        });
    };
    FichaEspecificaComponent.prototype.procesarDataAcciones = function (data) {
        var temporal = [];
        var dataretorno = [];
        data.forEach(function (i) {
            var busqueda = temporal.find(function (n) { return n.AccionCondicionId === i.AccionCondicionId; });
            if (typeof (busqueda) === 'undefined') {
                temporal.push(i);
            }
        });
        temporal.forEach(function (n) {
    ...
    FichaEspecificaComponent.prototype.cargarMomentosAudiencia = function (data) {
        this.loadMomentosAutiencia(this.informacionFicha.id, data.detalle);
    };
    FichaEspecificaComponent.prototype.loadMomentosAutiencia = function (idTramite, audiencias) {
        var _this = this;
        this.fichaTramiteService.GetMomentosByIdAudiencia(idTramite, audiencias).subscribe(function (n) {
            _this.audiencias.forEach(function (item) {
    ...
    FichaEspecificaComponent.prototype.ngOnChanges1 = function () {
    ...
    FichaEspecificaComponent.prototype.ngAfterViewChecked = function () {
        this.setNumeroTramite(this.numeroId);
    };
    FichaEspecificaComponent.prototype.setNumeroTramite = function (numero) {
        var s = document.getElementsByTagName('govco-area-servicios');
        if (s.length > 0) {
            s[0].setAttribute('itemid', 'T' + numero);
        }
    };
    FichaEspecificaComponent.prototype.tipoAudienciafuncion = function (audiencia) {
        this.ordenAudiencias = [];
        this.TitulosTipoAudiencia(this.numeroId, audiencia);
    };
    FichaEspecificaComponent.prototype.TitulosTipoAudiencia = function (numeroId, tipoAudiencia) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _a;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, this.fichaTramiteService.GetMomentosByIdAudiencia(numeroId, tipoAudiencia).toPromise()];
                    case 1:
                        _a.ordenAudiencias = _b.sent();
    ...
    FichaEspecificaComponent.prototype.dataMomentoAudiencia = function (tipoAudiencia, momento) {
        var _this = this;
        //this.activeIdsAcordeon.push(idacordeon);
        this.ordenAudiencias.forEach(function (item) {
            // let informacion = JSON.parse(item.Informacion);
            if (item.Informacion == "[]" && momento == item.Orden) {
                _this.fichaTramiteService.GetDataFichaByIdAudiencia(_this.numeroId, tipoAudiencia, momento).subscribe(function (res) {
                    _this.dataAudiencias = res;
                    _this.procesadorPrincipalData(_this.dataAudiencias, momento);
                });
            }
        });
    };
    FichaEspecificaComponent.prototype.procesadorPrincipalData = function (data, momento) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var e_1, _a, e_2, _b, CondicionNueva, OrdenAccion, subTitulo, descripcion, dataFormularios, nuevaData, nuevaDataExcepciones, dataExepcionesProcesada, excepciones, solicitud, ordenParcial, data_1, data_1_1, element, _loop_1, this_1, data_2, data_2_1, item, state_1, e_2_1, e_1_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        dataFormularios = {};
                        nuevaData = [];
                        nuevaDataExcepciones = [];
                        dataExepcionesProcesada = [];
                        excepciones = [];
                        solicitud = true;
                        this.dataExcepciones = [];
                        _c.label = 1;
                    case 1:
                        ...
                        data_1 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](data), data_1_1 = data_1.next();
                        _c.label = 2;
                    case 2:
                        if (!!data_1_1.done) return [3 /*break*/, 12];
                        element = data_1_1.value;
                        descripcion = [];
                        subTitulo = '';
                        solicitud = true;
                        ordenParcial = 0;
                        if (!(element.OrdenAccion > OrdenAccion)) return [3 /*break*/, 10];
                        CondicionNueva = element.CondicionNueva;
                        _loop_1 = function (item) {
                            var tipoDato, condicionExcepcion, tipoDato, documentoExcepcion, tipoDato, formularioExcepcion, dataCanales_1, tipoDato, canalExcepcion, dataPagos_1, tipoDato, pagoExcepcion;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        if (!(item.CondicionNueva == CondicionNueva)) return [3 /*break*/, 5];
                                        ...
                                        if (item.OrdenAccion >= element.OrdenAccion) {
                                            ...
                                            if (item.TipoAccionCondicion === 'VERIFICACION_INST' && item.OrdenAccion > ordenParcial) {
                                                ...
                                                tipoDato = this_1.tipoCondicionAudiencia(item.TipoAccionCondicion);
                                                ...
                                                if (item.Excepcion != null) {
                                                    documentoExcepcion = {
                                                        NombreExcepcion: item.Excepcion,
                                                        Tipo: tipoDato,
                                                        ContenidoExepcion: this_1.dataDocumentos(item)
                                                    };
                                                    excepciones.push(documentoExcepcion);
                                                }
                                                else {
                                                    descripcion.push(this_1.dataDocumentos(item));
                                                }
                                                subTitulo = tipoDato;
                                            }
                                                ...
                                                if (item.Excepcion != null) {
                                                    formularioExcepcion = {
                                                        NombreExcepcion: item.Excepcion,
                                                        Tipo: tipoDato,
                                                        ContenidoExepcion: this_1.dataFormularios(item)
                                                    };
                                                    excepciones.push(formularioExcepcion);
                                                }
                                                else {
                                                    descripcion.push(this_1.dataFormularios(item));
                                                }
                                                subTitulo = tipoDato;
                                            }
                                        }
                                        if (!(item.TipoAccionCondicion === 'SOLICITUD' && solicitud && element.OrdenAccion === OrdenAccion)) return [3 /*break*/, 2];
                                        tipoDato = this_1.tipoCondicionAudiencia(item.TipoAccionCondicion);
                                        return [4 /*yield*/, this_1.dataCanalAtencion(item).then(function (val) { return dataCanales_1 = val; })];
                                    case 1:
                                        _a.sent();
                                        if (item.Excepcion != null) {
                                            canalExcepcion = {
                                                NombreExcepcion: item.Excepcion,
                                                Tipo: tipoDato,
                                                ContenidoExepcion: dataCanales_1
                                            };
                                            excepciones.push(canalExcepcion);
                                        }
                                        else {
                                            descripcion.push(dataCanales_1);
                                        }
                                        subTitulo = tipoDato;
                                        solicitud = false;
                                        return [3 /*break*/, 4];
                                    case 2:
                                        if (!(item.TipoAccionCondicion == "PAGO" && solicitud && element.OrdenAccion == OrdenAccion)) return [3 /*break*/, 4];
                                        tipoDato = this_1.tipoCondicionAudiencia(item.TipoAccionCondicion);
                                        return [4 /*yield*/, this_1.dataPagos(item).then(function (val) { return dataPagos_1 = val; })];
                                    case 3:
                                        _a.sent();
                                        if (item.Excepcion) {
                                            pagoExcepcion = {
                                                NombreExcepcion: item.Excepcion,
                                                Tipo: tipoDato,
                                                ContenidoExepcion: dataPagos_1
                                            };
                                            excepciones.push(pagoExcepcion);
                                        }
                                        else {
                                            descripcion.push(dataPagos_1);
                                        }
                                        subTitulo = tipoDato;
                                        solicitud = false;
                                        _a.label = 4;
                                    ...
                                    case 5:
                                        if (item.OrdenAccion > OrdenAccion) {
                    ...
                    case 3:
                        ...
                        data_2 = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](data), data_2_1 = data_2.next();
                        _c.label = 4;
                    case 4:
    ...
    FichaEspecificaComponent.prototype.unionDataNuevaYExcepciones = function (nuevaData, nuevaDataExcepciones, momento) {
        var dataExepciones = [];
        ...
        this.ordenAudiencias.forEach(function (item) {
            if (item.Orden == momento) {
                var dataSerializada = JSON.stringify(nuevaData);
                item.Informacion = dataSerializada;
                if (dataExepciones.length > 0) {
                    var excepcionesSerializada = JSON.stringify(dataExepciones);
                    item.Excepcion = excepcionesSerializada;
                }
            }
        });
    };
    FichaEspecificaComponent.prototype.procesadorDataExepciones = function (data) {
        var NombreExcepcion;
        var NombresAcordeon = [];
        data.forEach(function (item) {
            item.forEach(function (itemInterno) {
                NombreExcepcion = itemInterno.NombreExcepcion;
                if (NombresAcordeon.length > 0) {
                    var result = NombresAcordeon.find(function (nombre) { return nombre === NombreExcepcion; });
                    if (result == null) {
        ...
        var dataOrganizadaExcepcion = this.ordenarDataSegunNombres(NombresAcordeon, data);
        return dataOrganizadaExcepcion;
    };
    FichaEspecificaComponent.prototype.ordenarDataSegunNombres = function (nombres, data) {
        var dataOrganizadaExcepcion = [];
        var contenido = [];
        nombres.forEach(function (nombre) {
            data.forEach(function (dataPasos) {
                dataPasos.map(function (itemData) {
                    if (itemData.NombreExcepcion == nombre) {
                        if (dataOrganizadaExcepcion.length > 0) {
                            var result = dataOrganizadaExcepcion.map(function (itemNombre) {
    ...
    ;
    FichaEspecificaComponent.prototype.dataPagos = function (item) {
        var _this = this;
        var descripcionPago = [];
        var ordenPago = 0;
        var entidadRecaudadora = [];
        var promise = new Promise(function (resolve, rejected) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var pagos, ObjetoPagos;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fichaTramiteService.GetPagosByMomentoIdAudiencia(this.numeroId, item.TipoAudiencia, item.OrdenMomento).toPromise()];
                    case 1:
                        pagos = _a.sent();
                        pagos.forEach(function (itemPagos) {
                            if (itemPagos.OrdenPago > 0) {
                                ...
                                if (entidadRecaudadora.length > 0) {
                                    var result = entidadRecaudadora.find(function (entidad) { return (entidad.nombreEntidad === itemPagos.NombreEntidad ||
    ...
    FichaEspecificaComponent.prototype.dataDocumentos = function (item) {
        var dataDocumentos = {
    ...
    FichaEspecificaComponent.prototype.dataFormularios = function (item) {
        var dataFormularios = {
    ...
    FichaEspecificaComponent.prototype.dataCanalAtencion = function (item) {
        var _this = this;
        var dataCanales;
        var descripcion = [];
        var canalAtencion = {};
        var promise = new Promise(function (resolve, rejected) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var canal, puntosAtencion;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.fichaTramiteService.GetCanalesByMomentoIdAudiencia(this.numeroId, item.TipoAudiencia, item.OrdenMomento).toPromise()];
                    case 1:
                        canal = _a.sent();
                        puntosAtencion = this.puntosAtencion;
                        canal.forEach(function (itemCanal) {
                            canalAtencion = {
                                canal: itemCanal
                            };
    ...
    FichaEspecificaComponent.prototype.tipoCondicionAudiencia = function (data) {
        var tipoCondicion;
        switch (data) {
    ...
    FichaEspecificaComponent.prototype.extractFromJson = function (obj) {
        obj = JSON.parse(obj);
        return obj;
    };
    FichaEspecificaComponent.prototype.showModal = function (data) {
        var modal = this.modalService.open(_puntos_atencion_modal_puntos_atencion_modal_component__WEBPACK_IMPORTED_MODULE_4__["PuntosAtencionComponent"], { size: 'lg',
            backdrop: "static",
            keyboard: false
        });
        if (data.tipo == "puntos") {
    ...
    FichaEspecificaComponent.prototype.redireccionar = function () {
        this.propagar.emit({ id: this.numeroId, tipo: 'Embebido', data: this.embebidos });
    };
    FichaEspecificaComponent.ctorParameters = function () { return [
    ...
    return FichaEspecificaComponent;
}());
...
var FichaEstandarComponent = /** @class */ (function () {
    function FichaEstandarComponent(route, fichaTramiteService, router) {
        this.route = route;
        this.fichaTramiteService = fichaTramiteService;
        this.router = router;
        this.propagar = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    FichaEstandarComponent.prototype.ngOnChanges = function () {
        var _this = this;
        if (this.tipoFicha == 602 && this.tipoFicha != undefined) {
            this.route.paramMap.subscribe(function (params) {
                _this.numeroId = _this.route.snapshot.params.id.substr(1, 20);
                _this.fichaTramiteService.GetInfoFichaEstandarById(_this.numeroId).subscribe(function (res) {
                    _this.dataBase = res;
                });
            });
            this.tipoFicha = 0;
    ...
    FichaEstandarComponent.prototype.idMunicipio = function (id) {
        this.propagar.emit({ id: id });
    };
    FichaEstandarComponent.ctorParameters = function () { return [
...
var FichaNoSuiteComponent = /** @class */ (function () {
    function FichaNoSuiteComponent(route, fichaTramiteService, router, modalService) {
        this.route = route;
        this.fichaTramiteService = fichaTramiteService;
        this.router = router;
        this.modalService = modalService;
    ...
    FichaNoSuiteComponent.prototype.ngOnChanges = function () {
        var _this = this;
        if (this.tipoFicha == "603" && this.tipoFicha != undefined) {
            this.route.paramMap.subscribe(function (params) {
                _this.numeroId = _this.route.snapshot.params.id.substr(1, 20);
                _this.fichaTramiteService.GetNotSuiteTramiteById(_this.route.snapshot.params.id).subscribe(function (data) {
                    _this.dataBase = data;
                });
                _this.fichaTramiteService.GetConsideracionesAdicionalesById(_this.route.snapshot.params.id).subscribe(function (data) {
                    _this.consideraciones = data;
                });
                _this.fichaTramiteService.GetPuntosAtencionNoSuitById(_this.route.snapshot.params.id).subscribe(function (data) {
                    _this.getDatosPuntosAtencion(data);
                });
            });
        }
    };
    FichaNoSuiteComponent.prototype.getDatosPuntosAtencion = function (data) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var e_1, _a, data_1, data_1_1, item, punto, e_1_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                    ...
                    case 1:
                        ...
                        item = data_1_1.value;
                        return [4 /*yield*/, this.fichaTramiteService.GetPuntosAtencionById(item.PuntosAtencionId).toPromise()];
                    case 2:
                        punto = _b.sent();
    ...
    FichaNoSuiteComponent.prototype.showModal = function (data) {
        var modal = this.modalService.open(_puntos_atencion_modal_puntos_atencion_modal_component__WEBPACK_IMPORTED_MODULE_5__["PuntosAtencionComponent"], { size: 'lg',
            backdrop: "static",
            keyboard: false
        });
        modal.componentInstance.puntosAtencion = data;
    };
    FichaNoSuiteComponent.prototype.ngAfterViewChecked = function () {
        this.setNumeroTramite(this.numeroId);
    };
    FichaNoSuiteComponent.prototype.setNumeroTramite = function (numero) {
        var s = document.getElementsByTagName('govco-area-servicios');
        if (s.length > 0) {
            s[0].setAttribute('itemid', "S" + numero);
        }
    };
    FichaNoSuiteComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"] },
        { type: _services_ficha_tramite_service__WEBPACK_IMPORTED_MODULE_3__["FichaTramiteService"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] },
...
var GeneralComponent = /** @class */ (function () {
    function GeneralComponent(fichaTramiteService, activatedRoute) {
        this.fichaTramiteService = fichaTramiteService;
    ...
    GeneralComponent.prototype.loadData = function () {
        var _this = this;
        var parametroid = this.activatedRoute.snapshot.params.id;
        var idTramiteTemp = parametroid;
        if (parametroid !== 'embebido') {
            ...
            this.fichaTramiteService.GetTipoFichaTramite(idTramiteTemp)
                ...
                _this.tramite.tipo = data.StatusCode;
            });
        }
        else {
            this.embebido = true;
    ...
    GeneralComponent.prototype.redireccionador = function (evento) {
...
var PuntosAtencionComponent = /** @class */ (function () {
    function PuntosAtencionComponent(activeModal) {
        this.activeModal = activeModal;
        this.p = 1;
    }
    PuntosAtencionComponent.prototype.ngOnInit = function () {
    };
    PuntosAtencionComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    PuntosAtencionComponent.ctorParameters = function () { return [
    ...
    return PuntosAtencionComponent;
}());
...
var RecursosModalComponent = /** @class */ (function () {
    function RecursosModalComponent(activeModal) {
        this.activeModal = activeModal;
    }
    RecursosModalComponent.prototype.ngAfterViewChecked = function () {
        this.setNumeroTramite(this.idTramite);
    };
    RecursosModalComponent.prototype.setNumeroTramite = function (numero) {
        var s = document.getElementsByTagName('govco-area-servicios');
        if (s.length > 0) {
            s[0].setAttribute('module-id', numero);
        }
    };
    RecursosModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    RecursosModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var FichaTramiteRoutingModule = /** @class */ (function () {
    function FichaTramiteRoutingModule() {
    }
    ...
    return FichaTramiteRoutingModule;
}());
...
var FichaTramiteModule = /** @class */ (function () {
    function FichaTramiteModule() {
    }
...
var API_URL = src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serverUrl;
var FichaTramiteService = /** @class */ (function () {
    function FichaTramiteService(http) {
        this.http = http;
    }
    FichaTramiteService.prototype.getGeneric = function (endPoint, parameters) {
        if (parameters === void 0) { parameters = ''; }
        return this.http.get("" + API_URL + endPoint + parameters);
    };
    FichaTramiteService.prototype.GetTipoFichaTramite = function (idTramite) {
        return this.getGeneric('FichaTramite/GetTipoFichaTramiteById/', idTramite);
    };
    FichaTramiteService.prototype.GetInfoBasicaEspecifica = function (idTramite) {
    ...
    FichaTramiteService.prototype.GetTipoTramiteFichaEspecificaById = function (idTramite) {
        return this.getGeneric('FichaTramite/GetTipoTramiteFichaEspecificaById/', idTramite);
    };
    FichaTramiteService.prototype.GetTiposAudienciaById = function (idTramite) {
        return this.getGeneric('FichaTramite/GetTiposAudienciaById/', idTramite);
    };
    FichaTramiteService.prototype.GetMomentosByIdAudiencia = function (idTramite, audiencia) {
        return this.getGeneric('FichaTramite/GetMomentosByIdAudiencia/', idTramite + "/" + audiencia);
    };
    FichaTramiteService.prototype.GetDataFichaByIdAudiencia = function (idTramite, audiencia, momento) {
        return this.getGeneric('FichaTramite/GetDataFichaByIdAudiencia/', idTramite + "/" + audiencia + "/" + momento);
    };
    FichaTramiteService.prototype.GetCanalesByMomentoIdAudiencia = function (idTramite, audiencia, momento) {
        return this.getGeneric('FichaTramite/GetCanalesByMomentoIdAudiencia/', idTramite + "/" + audiencia + "/" + momento);
    };
    FichaTramiteService.prototype.GetPuntosAtencionById = function (idTramite) {
        return this.getGeneric('FichaTramite/GetPuntosAtencionById/', idTramite);
    };
    FichaTramiteService.prototype.GetPagosByMomentoIdAudiencia = function (idTramite, audiencia, momento) {
        return this.getGeneric('FichaTramite/GetPagosByMomentoIdAudiencia/', idTramite + "/" + audiencia + "/" + momento);
    };
    FichaTramiteService.prototype.GetNormatividadById = function (idTramite) {
        return this.getGeneric('FichaTramite/GetNormatividadById/', idTramite);
    };
    FichaTramiteService.prototype.GetInfoFichaEstandarById = function (idTramite) {
        return this.getGeneric('FichaTramite/GetInfoFichaEstandarById/', idTramite);
    };
    FichaTramiteService.prototype.GetEmbebidosByIdTramite = function (idTramite) {
        return this.getGeneric('TramitesEmbebidos/GetEmbebidosByIdTramite/', idTramite);
    };
    FichaTramiteService.prototype.GetNotSuiteTramiteById = function (idTramite) {
        return this.getGeneric('FichaNoSuitTramite/GetNotSuiteTramiteById/', idTramite);
    };
    FichaTramiteService.prototype.GetConsideracionesAdicionalesById = function (idTramite) {
        return this.getGeneric('FichaNoSuitTramite/GetConsideracionesAdicionalesById/', idTramite);
    };
    FichaTramiteService.prototype.GetPuntosAtencionNoSuitById = function (idTramite) {
        return this.getGeneric('FichaNoSuitTramite/GetPuntosAtencionNoSuitById/', idTramite);
    };
    FichaTramiteService.ctorParameters = function () { return [
...
//# sourceMappingURL=tramites-fichatramite-ficha-tramite-module-es5.0ee30250d4a91ea30977.js.map