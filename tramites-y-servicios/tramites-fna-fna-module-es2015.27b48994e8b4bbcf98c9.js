...
let ConsultaDescargaReciboComponent = class ConsultaDescargaReciboComponent {
    constructor(ReciboPagoUtils, UserService) {
    ...
    ngOnInit() {
        ...
        response => {
            ...
            if (this.creditsCount == 0) {
                ...
                this.messages.failureRequest = _stringResources_tramites_recibo_pago_credito_json__WEBPACK_IMPORTED_MODULE_2__.messages.noCredits;
                return;
            }
        ...
        error => {
            this.failureRequest = true;
            this.hasCredits = false;
            this.messages.failureRequest = _stringResources_tramites_recibo_pago_credito_json__WEBPACK_IMPORTED_MODULE_2__.messages.failureRequest;
            window.scroll(0, 0);
            return;
        });
    }
...
ConsultaDescargaReciboComponent.ctorParameters = () => [
...
let LoginFnaComponent = class LoginFnaComponent {
    constructor(fb, modalService, ReciboPagoUtils, UserService, router) {
        this.fb = fb;
        ...
        response => {
            ...
            if (this.responseModel.success === false) {
                ...
                if (this.loginFailedAttempts < 2) {
                    this.messages.failureRequest = _stringResources_tramites_recibo_pago_credito_json__WEBPACK_IMPORTED_MODULE_2__.messages.loginFailed;
                }
                // 3 intentos o más
                else {
                    this.messages.failureRequest = _stringResources_tramites_recibo_pago_credito_json__WEBPACK_IMPORTED_MODULE_2__.messages.loginFailedAttempts;
                }
                this.invalidForm = true;
                window.scroll(0, 0);
                return;
...
LoginFnaComponent.ctorParameters = () => [
...
let ReciboPagoCreditoComponent = class ReciboPagoCreditoComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let FnaRoutingModule = class FnaRoutingModule {
};
...
let ReciboPagoUtilsService = class ReciboPagoUtilsService {
    constructor(http) {
        this.http = http;
        this.urlTramite = {
...
ReciboPagoUtilsService.ctorParameters = () => [
...
let UserService = class UserService {
    ...
    getDescTipoDocumento(tipoDoc) {
        return this.tiposDocumento[tipoDoc];
    }
    getDescEstadoCredito(estado) {
...
//# sourceMappingURL=tramites-fna-fna-module-es2015.27b48994e8b4bbcf98c9.js.map