...
var ObtenerRsppForm = /** @class */ (function () {
    function ObtenerRsppForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    ObtenerRsppForm.prototype.buildForm = function () {
    ...
    ObtenerRsppForm.prototype.getForm = function () {
        return this.form;
    };
    ObtenerRsppForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    ObtenerRsppForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return ObtenerRsppForm;
}());
...
var ObtenerRsppComponent = /** @class */ (function () {
    function ObtenerRsppComponent(service) {
    ...
    ObtenerRsppComponent.prototype.ngOnInit = function () { };
    ObtenerRsppComponent.prototype.buildForm = function () {
        this.generarFormObtenerRspp = this.formObtenerRspp.getForm();
    };
    ObtenerRsppComponent.prototype.getParams = function () {
        var _this = this;
    ...
    ObtenerRsppComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('steptramites', step);
    };
    ObtenerRsppComponent.prototype.actualizarDepartamento = function () {
        var _this = this;
        this.mostrarAlerta = false;
        this.setStep('2');
    ...
    ObtenerRsppComponent.prototype.limpiar = function () {
        this.mostrarAlerta = false;
        this.setStep('2');
    };
    ObtenerRsppComponent.prototype.search = function () {
        var _this = this;
        this.invalidForm = false;
        this.mostrarAlerta = false;
        this.tipoAlerta = '';
        ...
        if (!this.formObtenerRspp.isValid()) {
            ...
            this.service.GetCertificado(this.dataGenerar)
                ...
                _this.titulo = _stringResources_tramites_certificado_rspp_json__WEBPACK_IMPORTED_MODULE_4__.messages["200generarCertificado"];
                _this.mensajeAlerta = '';
                ...
                if (error.status == 404) {
                    ...
                    _this.mensajeAlerta = _stringResources_tramites_certificado_rspp_json__WEBPACK_IMPORTED_MODULE_4__.messages["404generarCertificado"];
                }
                else {
                    _this.mostrarAlerta = true;
                    _this.tipoAlerta = 'error';
                    _this.titulo = 'Lo sentimos';
                    _this.mensajeAlerta = _stringResources_tramites_certificado_rspp_json__WEBPACK_IMPORTED_MODULE_4__.messages["0generarCertificado"];
                }
                _this.setStep('2');
            });
        }
    };
    ObtenerRsppComponent.ctorParameters = function () { return [
...
var DescargarRsppRoutingModule = /** @class */ (function () {
    function DescargarRsppRoutingModule() {
    }
    ...
    return DescargarRsppRoutingModule;
}());
...
var DescargarRsppModule = /** @class */ (function () {
    function DescargarRsppModule() {
    }
...
var DatosSolicitud = /** @class */ (function () {
...
var DescargarRsppService = /** @class */ (function () {
    function DescargarRsppService(http) {
        this.http = http;
        // API path
    ...
    DescargarRsppService.prototype.getDepartamentos = function () {
    ...
    DescargarRsppService.prototype.getMunicipiosPor = function (codigoDepartamento) {
        return this.http.get(this.path + this.obtenerMunicipiosPor + codigoDepartamento, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().append("angular-show-loading", "true")
        });
    };
    DescargarRsppService.prototype.GetCertificado = function (datosSolicitud) {
    ...
    DescargarRsppService.ctorParameters = function () { return [
...
//# sourceMappingURL=tramites-ica-descargar-rspp-descargar-rspp-module-es5.d8dd2c5c3f870b45dd40.js.map