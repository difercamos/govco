...
var ObtenerGsmiForm = /** @class */ (function () {
    function ObtenerGsmiForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    ObtenerGsmiForm.prototype.buildForm = function () {
    ...
    ObtenerGsmiForm.prototype.getForm = function () {
        return this.form;
    };
    ObtenerGsmiForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    ObtenerGsmiForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return ObtenerGsmiForm;
}());
...
var ObtenerGsmiComponent = /** @class */ (function () {
    function ObtenerGsmiComponent(service) {
    ...
    ObtenerGsmiComponent.prototype.ngOnInit = function () { };
    ObtenerGsmiComponent.prototype.buildForm = function () {
        this.generarFormObtenerGsmi = this.formObtenerGsmi.getForm();
    };
    ObtenerGsmiComponent.prototype.getParams = function () {
    };
    ObtenerGsmiComponent.prototype.setStep = function (step) {
        var s = document.getElementsByTagName('govco-area-servicios');
        s[0].setAttribute('steptramites', step);
    };
    ObtenerGsmiComponent.prototype.limpiarFormulario = function () {
        this.buildForm();
    ...
    ObtenerGsmiComponent.prototype.limpiar = function () {
        this.mostrarAlerta = false;
        this.setStep('2');
    };
    ObtenerGsmiComponent.prototype.buscar = function () {
        var _this = this;
        this.invalidForm = false;
        this.mostrarAlerta = false;
        this.tipoAlerta = '';
    ...
    ObtenerGsmiComponent.ctorParameters = function () { return [
...
var DatosRespuesta = /** @class */ (function () {
...
var ValidarGsmiService = /** @class */ (function () {
    function ValidarGsmiService(http) {
        this.http = http;
        // API path
        this.path = 'ica/ValidarGsmi';
        this.obtenerInformacion = 'obtenerInformacion';
    }
    ValidarGsmiService.prototype.GetInformacion = function (datosSolicitud) {
    ...
    ValidarGsmiService.ctorParameters = function () { return [
...
var ValidarGsmiRoutingModule = /** @class */ (function () {
    function ValidarGsmiRoutingModule() {
    }
    ...
    return ValidarGsmiRoutingModule;
}());
...
var ValidarGsmiModule = /** @class */ (function () {
    function ValidarGsmiModule() {
    }
...
//# sourceMappingURL=tramites-ica-validar-gsmi-validar-gsmi-module-es5.73b84ec665c4797f7e3e.js.map