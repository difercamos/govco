...
let ForgotPasswordComponent = class ForgotPasswordComponent {
    ...
    forgotPassword() {
        ...
        response => {
            ...
            // Salida
            this.failureRequest = false;
            this.modalService.openNotificationDialog('Recordar contraseña exitoso', 'Hemos enviado la información al correo electrónico registrado', 'success', () => {
...
let RegistroIcbfComponent = class RegistroIcbfComponent {
    ...
    sendData() {
        ...
        response => {
            ...
            // Salida
            this.failureRequest = false;
            this.modalService.openNotificationDialog('Registro exitoso', 'Hemos enviado una confirmación al correo electrónico registrado', 'success', () => {
                this.router.navigate(['/ICBF/expedicion-estado-cuenta-aportes-parafiscales/T7760']);
            });
        }, 
        // Failure response
