...
let CensoIndigenaRoutingModule = class CensoIndigenaRoutingModule {
};
...
let CensoIndigenaModule = class CensoIndigenaModule {
};
...
let BuscarCertificadoComponent = class BuscarCertificadoComponent {
    constructor(censoIndigenaService) {
    ...
    generar() {
        ...
        if (!this.buscarCertificadoForm.isValid()) {
            ...
            this.censoIndigenaService.postGenerarCertificado(this.dataGenerar)
                ...
                this.titulo = _stringResources_tramites_censo_indigena_json__WEBPACK_IMPORTED_MODULE_3__.messages["200generarCertificado"];
                this.mensajeAlerta = '';
                ...
                if (error.status == 404) {
                    ...
                    this.tipoAlerta = 'error';
                    this.titulo = 'Lo sentimos';
                    this.mensajeAlerta = _stringResources_tramites_censo_indigena_json__WEBPACK_IMPORTED_MODULE_3__.messages["404generarCertificado"];
                }
                else {
                    this.mostrarAlerta = true;
                    this.tipoAlerta = 'error';
                    this.titulo = 'Lo sentimos';
                    this.mensajeAlerta = _stringResources_tramites_censo_indigena_json__WEBPACK_IMPORTED_MODULE_3__.messages["0generarCertificado"];
                }
                this.setStep('2');
            });
        }
    ...
    validar() {
        ...
        if (!this.validarCertificadoForm.isValid()) {
            ...
            this.censoIndigenaService.postValidarCertificado(this.dataValidar)
                ...
                this.mostrarAlerta = true;
                this.tipoAlerta = 'success';
                this.titulo = _stringResources_tramites_censo_indigena_json__WEBPACK_IMPORTED_MODULE_3__.messages["200validarCertificado"];
                this.mensajeAlerta = '';
                let blob = new Blob([data], { type: 'application/pdf' });
                let url = window.URL.createObjectURL(blob);
                if (window.navigator && window.navigator.msSaveOrOpenBlob) {
                ...
                if (error.status == 404) {
                    ...
                    this.tipoAlerta = 'error';
                    this.titulo = 'Lo sentimos';
                    this.mensajeAlerta = _stringResources_tramites_censo_indigena_json__WEBPACK_IMPORTED_MODULE_3__.messages["404validarCertificado"];
                }
                else {
                    this.mostrarAlerta = true;
                    this.tipoAlerta = 'error';
...
BuscarCertificadoComponent.ctorParameters = () => [
...
let CensoIndigenaComponent = class CensoIndigenaComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let CensoIndigenaService = class CensoIndigenaService {
    constructor(http) {
        this.http = http;
        // API path
...
CensoIndigenaService.ctorParameters = () => [
...
//# sourceMappingURL=tramites-mininterior-censo-indigena-censo-indigena-module-es2015.d1947ecfc5264bf31640.js.map