...
var CapacidadDetalleModalComponent = /** @class */ (function () {
    function CapacidadDetalleModalComponent(activeModal, concultaService) {
        this.activeModal = activeModal;
        this.concultaService = concultaService;
    }
    CapacidadDetalleModalComponent.prototype.ngOnInit = function () {
    };
    CapacidadDetalleModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    CapacidadDetalleModalComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    CapacidadDetalleModalComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.closeModal();
    };
    CapacidadDetalleModalComponent.ctorParameters = function () { return [
    ...
    return CapacidadDetalleModalComponent;
}());
...
var CapacidadDetalleComponent = /** @class */ (function () {
    function CapacidadDetalleComponent(concultaService, modalService) {
        this.concultaService = concultaService;
        this.modalService = modalService;
        this.concultaService.asignarDescargaCompleta(false);
    }
    CapacidadDetalleComponent.prototype.ngOnInit = function () { };
    CapacidadDetalleComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.modalService.dismissAll();
    };
    CapacidadDetalleComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    CapacidadDetalleComponent.ctorParameters = function () { return [
    ...
    return CapacidadDetalleComponent;
}());
...
var CapacidadFiltroComponent = /** @class */ (function () {
    function CapacidadFiltroComponent(concultaService, capacidadDetalle) {
        this.concultaService = concultaService;
    ...
    CapacidadFiltroComponent.prototype.inicializarForm = function () {
    ...
    CapacidadFiltroComponent.prototype.buscar = function () {
        var _this = this;
        ...
        Object.keys(this.formGroup.controls).forEach(function (key) {
            var data = _this.formGroup.get(key).value;
            ...
            _this.concultaService.filtro[key] = data;
        ...
        if (filterNumber > 0) {
            this.concultaService.invalidForm = false;
            this.concultaService.getDetalle(this.concultaService.tipoDetalle.sanciones).subscribe(function (data) { return _this.success(data); }, function (error) {
                _this.concultaService.invalidForm = true;
                _this.errorMessage.message = _services_messages_filters__WEBPACK_IMPORTED_MODULE_5__["MESSAGES"].Error;
                _this.errorMessage.title = _services_messages_filters__WEBPACK_IMPORTED_MODULE_5__["MESSAGES"].Sorry;
            });
        }
        else {
            this.concultaService.invalidForm = true;
    ...
    CapacidadFiltroComponent.prototype.success = function (data) {
        if (data.length > 0) {
    ...
    CapacidadFiltroComponent.prototype.limpiar = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    CapacidadFiltroComponent.prototype.descargarResultados = function () {
        var _this = this;
        this.concultaService.getDetalleExcel(this.concultaService.tipoDetalle.capacidad).subscribe(function (data) {
            var newBlob = new Blob([data], { type: 'application/vnd.ms-excel' });
            // IE
            if (window.navigator && window.navigator.msSaveOrOpenBlob && _this.concultaService.isIE()) {
            ...
            link.download = 'Consulta de prestadores de salud ' + _this.concultaService.tipoDetalle.capacidad + '.xls';
            link.click();
            // Habilita mensaje success
            _this.concultaService.asignarDescargaCompleta(true);
            _this.successDownload = true;
            _this.concultaService.invalidForm = false;
            _this.concultaService.backToTop();
        }, function (error) {
            _this.concultaService.asignarDescargaCompleta(false);
            _this.successDownload = false;
            _this.concultaService.invalidForm = true;
            _this.errorMessage.message = _services_messages_filters__WEBPACK_IMPORTED_MODULE_5__["MESSAGES"].ErrorDownload;
            _this.errorMessage.title = _services_messages_filters__WEBPACK_IMPORTED_MODULE_5__["MESSAGES"].Sorry;
            _this.concultaService.backToTop();
        });
    };
    CapacidadFiltroComponent.prototype.ngOnInit = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    CapacidadFiltroComponent.prototype.cargarMunicipios = function () {
    ...
    CapacidadFiltroComponent.ctorParameters = function () { return [
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
    ...
    return CapacidadFiltroComponent;
}());
...
var GeneralComponent = /** @class */ (function () {
    function GeneralComponent(concultaServices) {
...
var PrestadoresDetalleModalComponent = /** @class */ (function () {
    function PrestadoresDetalleModalComponent(activeModal, concultaService) {
        this.activeModal = activeModal;
        this.concultaService = concultaService;
        this.concultaService.inicializarRegistroSeleccionado();
    }
    PrestadoresDetalleModalComponent.prototype.ngOnInit = function () { };
    PrestadoresDetalleModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    PrestadoresDetalleModalComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    PrestadoresDetalleModalComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.closeModal();
    };
    PrestadoresDetalleModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_3__["MinsaludConsultaUtilService"] }
    ]; };
    ...
    return PrestadoresDetalleModalComponent;
}());
...
var PrestadoresDetalleComponent = /** @class */ (function () {
    function PrestadoresDetalleComponent(location, http, concultaService, modalService) {
        var _this = this;
        ...
        this.abrirPopup = function (e, item, index) {
            var modal = _this.modalService.open(_prestadores_detalle_modal_prestadores_detalle_modal_component__WEBPACK_IMPORTED_MODULE_4__["PrestadoresDetalleModalComponent"], {
                size: 'lg',
                backdrop: 'static',
                keyboard: false,
                centered: true
    ...
    PrestadoresDetalleComponent.prototype.getTabla = function () {
        return this.concultaService.tDetail;
    };
    PrestadoresDetalleComponent.prototype.open = function (content) {
        this.modalService.open(content, { size: "lg", windowClass: "modal-detail-govco", scrollable: true });
    };
    PrestadoresDetalleComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.modalService.dismissAll();
    };
    PrestadoresDetalleComponent.prototype.ngOnInit = function () {
        this.getDetalleConsulta();
        this.inicializarTablaDetallePrestadores();
    };
    PrestadoresDetalleComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    PrestadoresDetalleComponent.prototype.inicializarTablaDetallePrestadores = function () {
        this.tDetail = {
            Header: [
    ...
    PrestadoresDetalleComponent.prototype.getDetalleConsulta = function () {
        var _this = this;
        //console.log('Prestador detalle Ingresa a getDetalleConsulta...');
        this.getDetalle().subscribe(
        // Success response
        function (response) {
            _this.detalleConsulta = response;
            if (_this.detalleConsulta != null) {
                console.log('Trae bien...this.detalleConsulta.length=' + _this.detalleConsulta.length);
            }
    ...
    // Cargar detalle
    PrestadoresDetalleComponent.prototype.getDetalle = function () {
    ...
    // Error petición
    PrestadoresDetalleComponent.prototype.errorHandler = function (error) {
    ...
    */
    PrestadoresDetalleComponent.prototype.setTablaDetalleDatos = function () {
        //Se recorre la lista de objetos
        for (var indexDatos = 0; indexDatos < this.detalleConsulta.length; indexDatos++) {
            var listElements = [];
            var data = Object.keys(this.detalleConsulta[indexDatos]);
            //Se recorre el array de campos para asignarlos en el orden que se requiere
            for (var indexIds = 0; indexIds < this.idsTabla.length; indexIds++) {
                // Se recorre la fila, para obtener el orden especifico que se requiere
                for (var j = 0; j < data.length; j++) {
                    var element = this.detalleConsulta[indexDatos][data[j]];
                    var el = {
                        content: element
                    };
    ...
    PrestadoresDetalleComponent.prototype.abrirPopup1 = function (e, item, index) {
    ...
    PrestadoresDetalleComponent.ctorParameters = function () { return [
    ...
    return PrestadoresDetalleComponent;
}());
...
var PrestadoresFiltroComponent = /** @class */ (function () {
    function PrestadoresFiltroComponent(concultaService, prestadoresDetalle) {
        this.concultaService = concultaService;
    ...
    PrestadoresFiltroComponent.prototype.inicializarForm = function () {
        this.formGroup = this.formBuilder.group({
            numero_documento: [''],
            naturaleza_juridica: [''],
    ...
    PrestadoresFiltroComponent.prototype.buscar = function () {
        var _this = this;
        this.successDownload = false;
        if (this.formGroup.get('recaptcha').value === null) {
            this.concultaService.invalidRecaptcha = true;
        ...
        if (filterNumber > 0) {
            this.concultaService.invalidForm = false;
            this.concultaService.getDetalle(this.concultaService.tipoDetalle.prestadores).subscribe(function (data) { return _this.success(data); }, function (error) {
                _this.concultaService.invalidForm = true;
                _this.errorMessage.message = _services_messages_filters__WEBPACK_IMPORTED_MODULE_5__["MESSAGES"].Error;
                _this.errorMessage.title = _services_messages_filters__WEBPACK_IMPORTED_MODULE_5__["MESSAGES"].Sorry;
            });
    ...
    PrestadoresFiltroComponent.prototype.success = function (data) {
        if (data.length > 0) {
            this.concultaService.detalleConsulta = data;
            this.concultaService.setTablaDetalleDatos(this.concultaService.idsTablaSanciones);
            this.concultaService.asignarMostrarDetalle(true);
    ...
    PrestadoresFiltroComponent.prototype.limpiar = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.inicializarForm();
    };
    PrestadoresFiltroComponent.prototype.descargarResultados = function () {
        var _this = this;
        this.concultaService.getDetalleExcel(this.concultaService.tipoDetalle.prestadores).subscribe(function (data) {
            var newBlob = new Blob([data], { type: 'application/vnd.ms-excel' });
            // IE
            if (window.navigator && window.navigator.msSaveOrOpenBlob && _this.concultaService.isIE()) {
                window.navigator.msSaveOrOpenBlob(newBlob);
            ...
            var link = document.createElement('a');
            link.href = downloadURL;
            link.download = 'Consulta de prestadores de salud ' + _this.concultaService.tipoDetalle.prestadores + '.xls';
            link.click();
            // Habilita mensaje success
            _this.concultaService.asignarDescargaCompleta(true);
            _this.successDownload = true;
    ...
    PrestadoresFiltroComponent.prototype.ngOnInit = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    PrestadoresFiltroComponent.prototype.cargarMunicipios = function () {
    ...
    PrestadoresFiltroComponent.ctorParameters = function () { return [
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
    ...
    return PrestadoresFiltroComponent;
}());
...
var SancionesDetalleModalComponent = /** @class */ (function () {
    function SancionesDetalleModalComponent(activeModal, concultaService) {
        this.activeModal = activeModal;
        this.concultaService = concultaService;
    }
    SancionesDetalleModalComponent.prototype.ngOnInit = function () {
    };
    SancionesDetalleModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    SancionesDetalleModalComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    SancionesDetalleModalComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.closeModal();
    };
    SancionesDetalleModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_3__["MinsaludConsultaUtilService"] }
    ]; };
    ...
    return SancionesDetalleModalComponent;
}());
...
var SancionesDetalleComponent = /** @class */ (function () {
    function SancionesDetalleComponent(http, concultaService, modalService) {
        var _this = this;
        this.http = http;
        this.concultaService = concultaService;
        this.modalService = modalService;
        ...
        // NOTA: Debe ser tipo anonima para que el contexto de la clase se mantenga
        this.abrirPopup = function (e, item, index) {
            var modal = _this.modalService.open(_sanciones_detalle_modal_sanciones_detalle_modal_component__WEBPACK_IMPORTED_MODULE_3__["SancionesDetalleModalComponent"], {
                size: 'lg',
                backdrop: 'static',
                keyboard: false,
                centered: true
    ...
    SancionesDetalleComponent.prototype.open = function (content) {
        this.modalService.open(content, { size: "lg", windowClass: "modal-detail-govco", scrollable: true });
    };
    SancionesDetalleComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.modalService.dismissAll();
    };
    SancionesDetalleComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    SancionesDetalleComponent.prototype.ngOnInit = function () {
        this.getDetalleConsulta();
        this.inicializarTablaDetalleSanciones();
        this.setTablaDetalleDatos();
    };
    SancionesDetalleComponent.prototype.inicializarTablaDetalleSanciones = function () {
        this.tDetail = {
            Header: [
    ...
    SancionesDetalleComponent.prototype.getDetalleConsulta = function () {
        var _this = this;
        //console.log('Prestador detalle Ingresa a getDetalleConsulta...');
        this.getDetalle().subscribe(
        // Success response
        function (response) {
            ...
            _this.inicializarTablaDetalleSanciones();
            _this.setTablaDetalleDatos();
            //Se activan las banderas respectivas para que se muestre el detalle
            _this.concultaService.asignarMostrarDetalle(true);
            _this.concultaService.asignarMostrarDetalleSinResultados(false);
            //console.log('Activa bandera...');
        }, 
        // Failure response
        function (error) {
    ...
    // Cargar detalle
    SancionesDetalleComponent.prototype.getDetalle = function () {
    ...
    // Error petición
    SancionesDetalleComponent.prototype.errorHandler = function (error) {
    ...
    param: idsTablaSedesParam = Array definido en esta clase this.idsTablaSedes
    */
    SancionesDetalleComponent.prototype.setTablaDetalleDatos = function () {
        //Se recorre la lista de objetos
        for (var indexDatos = 0; indexDatos < this.detalleConsulta.length; indexDatos++) {
            var listElements = [];
            var data = Object.keys(this.detalleConsulta[indexDatos]);
            //Se recorre el array de campos para asignarlos en el orden que se requiere
            for (var indexIds = 0; indexIds < this.idsTablaSanciones.length; indexIds++) {
                // Se recorre la fila, para obtener el orden especifico que se requiere
                for (var j = 0; j < data.length; j++) {
                    var element = this.detalleConsulta[indexDatos][data[j]];
                    var el = {
    ...
    SancionesDetalleComponent.ctorParameters = function () { return [
    ...
    return SancionesDetalleComponent;
}());
...
var SancionesFiltroComponent = /** @class */ (function () {
    function SancionesFiltroComponent(concultaService, sancionesDetalle) {
        this.concultaService = concultaService;
    ...
    SancionesFiltroComponent.prototype.inicializarForm = function () {
        this.formGroup = this.formBuilder.group({
            numero_documento: [''],
            naturaleza_juridica: [''],
            grupo: [''],
    ...
    SancionesFiltroComponent.prototype.search = function () {
    ...
    SancionesFiltroComponent.prototype.success = function (data) {
        if (data.length > 0) {
            this.concultaService.detalleConsulta = data;
            this.concultaService.setTablaDetalleDatos(this.concultaService.idsTablaSanciones);
            this.concultaService.asignarMostrarDetalle(true);
    ...
    SancionesFiltroComponent.prototype.limpiar = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    SancionesFiltroComponent.prototype.descargarResultados = function () {
        var _this = this;
        this.concultaService.getDetalleExcel(this.concultaService.tipoDetalle.sanciones).subscribe(function (data) {
            var newBlob = new Blob([data], { type: 'application/vnd.ms-excel' });
            // IE
            if (window.navigator && window.navigator.msSaveOrOpenBlob && _this.concultaService.isIE()) {
                window.navigator.msSaveOrOpenBlob(newBlob);
            ...
            var link = document.createElement('a');
            link.href = downloadURL;
            link.download = 'Consulta de prestadores de salud ' + _this.concultaService.tipoDetalle.sanciones + '.xls';
            link.click();
            // Habilita mensaje success
            _this.concultaService.asignarDescargaCompleta(true);
            _this.successDownload = true;
    ...
    SancionesFiltroComponent.prototype.ngOnInit = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    SancionesFiltroComponent.prototype.cargarMunicipios = function () {
        this.concultaService.cargarMunicipios(this.formGroup.get('departamento_sede').value.value);
        this.formGroup.get('municipio_sede').setValue(null);
    };
    SancionesFiltroComponent.ctorParameters = function () { return [
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
    ...
    return SancionesFiltroComponent;
}());
...
var SedesDetalleModalComponent = /** @class */ (function () {
    function SedesDetalleModalComponent(activeModal, concultaService) {
        this.activeModal = activeModal;
        this.concultaService = concultaService;
    }
    SedesDetalleModalComponent.prototype.ngOnInit = function () {
    };
    SedesDetalleModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    SedesDetalleModalComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    SedesDetalleModalComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.closeModal();
    };
    SedesDetalleModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_3__["MinsaludConsultaUtilService"] }
    ]; };
    ...
    return SedesDetalleModalComponent;
}());
...
var SedesDetalleComponent = /** @class */ (function () {
    function SedesDetalleComponent(http, concultaService, modalService) {
        var _this = this;
        this.http = http;
        this.concultaService = concultaService;
        this.modalService = modalService;
        ...
        // NOTA: Debe ser tipo anonima para que el contexto de la clase se mantenga
        this.abrirPopup = function (e, item, index) {
            var modal = _this.modalService.open(_sedes_detalle_modal_sedes_detalle_modal_component__WEBPACK_IMPORTED_MODULE_7__["SedesDetalleModalComponent"], {
                size: 'lg',
                backdrop: 'static',
                keyboard: false,
                centered: true
    ...
    SedesDetalleComponent.prototype.open = function (content) {
        this.modalService.open(content, { size: "lg", windowClass: "modal-detail-govco", scrollable: true });
    };
    SedesDetalleComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    SedesDetalleComponent.prototype.ngOnInit = function () {
        this.getDetalleConsulta();
        this.inicializarTablaDetalleSedes();
        this.setTablaDetalleDatos();
    };
    SedesDetalleComponent.prototype.inicializarTablaDetalleSedes = function () {
        this.tDetail = {
            Header: [
                { content: 'Nombre prestador', filter: false, typeFilter: '' },
                { content: 'Código prestador', filter: false, typeFilter: '' },
    ...
    SedesDetalleComponent.prototype.getDetalleConsulta = function () {
        var _this = this;
        //console.log('Prestador detalle Ingresa a getDetalleConsulta...');
        this.getDetalle().subscribe(
        // Success response
        function (response) {
            _this.detalleConsulta = response;
            //console.log('Trae bien...this.detalleConsulta.length='+this.detalleConsulta.length);
            _this.inicializarTablaDetalleSedes();
            _this.setTablaDetalleDatos();
            //Se activan las banderas respectivas para que se muestre el detalle
            _this.concultaService.asignarMostrarDetalle(true);
            _this.concultaService.asignarMostrarDetalleSinResultados(false);
    ...
    // Cargar detalle
    SedesDetalleComponent.prototype.getDetalle = function () {
    ...
    // Error petición
    SedesDetalleComponent.prototype.errorHandler = function (error) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(error);
    };
    /*
    Función que llena la tabla detalle con las columnas especificadas en el array que pasa por parametro
    param: idsTablaSedesParam = Array definido en esta clase this.idsTablaSedes
    */
    SedesDetalleComponent.prototype.setTablaDetalleDatos = function () {
        //Se recorre la lista de objetos
        for (var indexDatos = 0; indexDatos < this.detalleConsulta.length; indexDatos++) {
            var listElements = [];
            var data = Object.keys(this.detalleConsulta[indexDatos]);
            //Se recorre el array de campos para asignarlos en el orden que se requiere
            for (var indexIds = 0; indexIds < this.idsTablaSedes.length; indexIds++) {
                // Se recorre la fila, para obtener el orden especifico que se requiere
                for (var j = 0; j < data.length; j++) {
                    var element = this.detalleConsulta[indexDatos][data[j]];
                    var el = {
    ...
    SedesDetalleComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] }
    ]; };
...
var SedesFiltroComponent = /** @class */ (function () {
    function SedesFiltroComponent(concultaService, sedesDetalle) {
        this.concultaService = concultaService;
    ...
    SedesFiltroComponent.prototype.inicializarForm = function () {
    ...
    SedesFiltroComponent.prototype.buscar = function () {
        var _this = this;
        this.concultaService.invalidRecaptcha = false;
        this.successDownload = false;
        if (this.formGroup.get('recaptcha').value === null) {
    ...
    SedesFiltroComponent.prototype.success = function (data) {
        if (data.length > 0) {
            this.concultaService.detalleConsulta = data;
            this.concultaService.setTablaDetalleDatos(this.concultaService.idsTablaSanciones);
            this.concultaService.asignarMostrarDetalle(true);
    ...
    SedesFiltroComponent.prototype.limpiar = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    SedesFiltroComponent.prototype.descargarResultados = function () {
        var _this = this;
        this.concultaService.getDetalleExcel(this.concultaService.tipoDetalle.sedes).subscribe(function (data) {
            var newBlob = new Blob([data], { type: 'application/vnd.ms-excel' });
            // IE
            if (window.navigator && window.navigator.msSaveOrOpenBlob && _this.concultaService.isIE()) {
                window.navigator.msSaveOrOpenBlob(newBlob);
            ...
            var link = document.createElement('a');
            link.href = downloadURL;
            link.download = 'Consulta de prestadores de salud ' + _this.concultaService.tipoDetalle.sedes + '.xls';
            link.click();
            // Habilita mensaje success
            _this.concultaService.asignarDescargaCompleta(true);
            _this.successDownload = true;
    ...
    SedesFiltroComponent.prototype.ngOnInit = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    SedesFiltroComponent.prototype.cargarMunicipios = function () {
        this.concultaService.cargarMunicipios(this.formGroup.get('departamento_prestador').value.value);
        this.formGroup.get('municipio_prestador').setValue(null);
    };
    SedesFiltroComponent.prototype.cargarMunicipios2 = function () {
        this.concultaService.cargarMunicipios2(this.formGroup.get('departamento_sede').value.value);
        this.formGroup.get('municipio_sede').setValue(null);
    };
    SedesFiltroComponent.ctorParameters = function () { return [
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
...
var SeguridadDetalleModalComponent = /** @class */ (function () {
    function SeguridadDetalleModalComponent(activeModal, concultaService) {
        this.activeModal = activeModal;
        this.concultaService = concultaService;
    }
    SeguridadDetalleModalComponent.prototype.ngOnInit = function () {
    };
    SeguridadDetalleModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    SeguridadDetalleModalComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    SeguridadDetalleModalComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.closeModal();
    };
    SeguridadDetalleModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_3__["MinsaludConsultaUtilService"] }
    ]; };
    ...
    return SeguridadDetalleModalComponent;
}());
...
var SeguridadDetalleComponent = /** @class */ (function () {
    function SeguridadDetalleComponent(http, concultaService, modalService) {
        var _this = this;
        this.http = http;
        this.concultaService = concultaService;
        this.modalService = modalService;
        ...
        // NOTA: Debe ser tipo anonima para que el contexto de la clase se mantenga
        this.abrirPopup = function (e, item, index) {
            var modal = _this.modalService.open(_seguridad_detalle_modal_seguridad_detalle_modal_component__WEBPACK_IMPORTED_MODULE_7__["SeguridadDetalleModalComponent"], {
                size: 'lg',
                backdrop: 'static',
                keyboard: false,
                centered: true
    ...
    SeguridadDetalleComponent.prototype.open = function (content) {
        this.modalService.open(content, { size: "lg", windowClass: "modal-detail-govco", scrollable: true });
    };
    SeguridadDetalleComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.modalService.dismissAll();
    };
    SeguridadDetalleComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    SeguridadDetalleComponent.prototype.ngOnInit = function () {
        this.getDetalleConsulta();
        this.inicializarTablaDetalleSeguridad();
        this.setTablaDetalleDatos();
    };
    SeguridadDetalleComponent.prototype.inicializarTablaDetalleSeguridad = function () {
        this.tDetail = {
            Header: [
                { content: 'Nombre prestador', filter: false, typeFilter: '' },
                { content: 'Código prestador', filter: false, typeFilter: '' },
    ...
    SeguridadDetalleComponent.prototype.getDetalleConsulta = function () {
        var _this = this;
        //console.log('Prestador detalle Ingresa a getDetalleConsulta...');
        this.getDetalle().subscribe(
        // Success response
        function (response) {
            _this.detalleConsulta = response;
            //console.log('Trae bien...this.detalleConsulta.length='+this.detalleConsulta.length);
            _this.inicializarTablaDetalleSeguridad();
            _this.setTablaDetalleDatos();
            //Se activan las banderas respectivas para que se muestre el detalle
            _this.concultaService.asignarMostrarDetalle(true);
            _this.concultaService.asignarMostrarDetalleSinResultados(false);
    ...
    // Cargar detalle
    SeguridadDetalleComponent.prototype.getDetalle = function () {
    ...
    // Error petición
    SeguridadDetalleComponent.prototype.errorHandler = function (error) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(error);
    };
    /*
    Función que llena la tabla detalle con las columnas especificadas en el array que pasa por parametro
    param: idsTablaSedesParam = Array definido en esta clase this.idsTablaSedes
    */
    SeguridadDetalleComponent.prototype.setTablaDetalleDatos = function () {
        //Se recorre la lista de objetos
        for (var indexDatos = 0; indexDatos < this.detalleConsulta.length; indexDatos++) {
            var listElements = [];
            var data = Object.keys(this.detalleConsulta[indexDatos]);
            //Se recorre el array de campos para asignarlos en el orden que se requiere
            for (var indexIds = 0; indexIds < this.idsTablaSeguridad.length; indexIds++) {
                // Se recorre la fila, para obtener el orden especifico que se requiere
                for (var j = 0; j < data.length; j++) {
                    var element = this.detalleConsulta[indexDatos][data[j]];
                    var el = {
    ...
    SeguridadDetalleComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] }
    ]; };
    ...
    return SeguridadDetalleComponent;
}());
...
var SeguridadFiltroComponent = /** @class */ (function () {
    function SeguridadFiltroComponent(concultaService, seguridadDetalle) {
        this.concultaService = concultaService;
    ...
    SeguridadFiltroComponent.prototype.inicializarForm = function () {
        this.formGroup = this.formBuilder.group({
            numero_documento: [''],
            naturaleza_juridica: [''],
            grupo: [''],
    ...
    SeguridadFiltroComponent.prototype.buscar = function () {
        var _this = this;
        this.concultaService.invalidRecaptcha = false;
        this.successDownload = false;
        if (this.formGroup.get('recaptcha').value === null) {
    ...
    SeguridadFiltroComponent.prototype.success = function (data) {
        if (data.length > 0) {
            this.concultaService.detalleConsulta = data;
            this.concultaService.setTablaDetalleDatos(this.concultaService.idsTablaSanciones);
            this.concultaService.asignarMostrarDetalle(true);
    ...
    SeguridadFiltroComponent.prototype.limpiar = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    SeguridadFiltroComponent.prototype.descargarResultados = function () {
        var _this = this;
        this.concultaService.getDetalleExcel(this.concultaService.tipoDetalle.seguridad).subscribe(function (data) {
            var newBlob = new Blob([data], { type: 'application/vnd.ms-excel' });
            // IE
            if (window.navigator && window.navigator.msSaveOrOpenBlob && _this.concultaService.isIE()) {
                window.navigator.msSaveOrOpenBlob(newBlob);
            ...
            var link = document.createElement('a');
            link.href = downloadURL;
            link.download = 'Consulta de prestadores de salud ' + _this.concultaService.tipoDetalle.seguridad + '.xls';
            link.click();
            // Habilita mensaje success
            _this.concultaService.asignarDescargaCompleta(true);
            _this.successDownload = true;
    ...
    SeguridadFiltroComponent.prototype.ngOnInit = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    SeguridadFiltroComponent.prototype.cargarMunicipios = function () {
        this.concultaService.cargarMunicipios(this.formGroup.get('departamento_sede').value.value);
        this.formGroup.get('municipio_sede').setValue(null);
    };
    SeguridadFiltroComponent.ctorParameters = function () { return [
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
    ...
    return SeguridadFiltroComponent;
}());
...
var ServiciosDetalleModalComponent = /** @class */ (function () {
    function ServiciosDetalleModalComponent(activeModal, concultaService) {
        this.activeModal = activeModal;
        this.concultaService = concultaService;
    }
    ServiciosDetalleModalComponent.prototype.ngOnInit = function () {
    };
    ServiciosDetalleModalComponent.prototype.closeModal = function () {
        this.activeModal.close();
    };
    ServiciosDetalleModalComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    ServiciosDetalleModalComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.closeModal();
    };
    ServiciosDetalleModalComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_2__["NgbActiveModal"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_3__["MinsaludConsultaUtilService"] }
    ]; };
    ...
    return ServiciosDetalleModalComponent;
}());
...
var ServiciosDetalleComponent = /** @class */ (function () {
    function ServiciosDetalleComponent(http, concultaService, modalService) {
        var _this = this;
        this.http = http;
        this.concultaService = concultaService;
        this.modalService = modalService;
        ...
        // NOTA: Debe ser tipo anonima para que el contexto de la clase se mantenga
        this.abrirPopup = function (e, item, index) {
            var modal = _this.modalService.open(_servicios_detalle_modal_servicios_detalle_modal_component__WEBPACK_IMPORTED_MODULE_7__["ServiciosDetalleModalComponent"], {
                size: 'lg',
                backdrop: 'static',
                keyboard: false,
                centered: true
    ...
    ServiciosDetalleComponent.prototype.open = function (content) {
        this.modalService.open(content, { size: "lg", windowClass: "modal-detail-govco", scrollable: true });
    };
    ServiciosDetalleComponent.prototype.closeModalConDescarga = function () {
        this.descargarResultados();
        this.modalService.dismissAll();
    };
    ServiciosDetalleComponent.prototype.descargarResultados = function () {
        this.concultaService.asignarDescargaCompleta(true);
    };
    ServiciosDetalleComponent.prototype.ngOnInit = function () {
        this.getDetalleConsulta();
        this.inicializarTablaDetalleServicios();
        this.setTablaDetalleDatos();
    };
    ServiciosDetalleComponent.prototype.inicializarTablaDetalleServicios = function () {
        this.tDetail = {
            Header: [
                { content: 'Departamento', filter: false, typeFilter: '' },
                { content: 'Municipio', filter: false, typeFilter: '' },
    ...
    ServiciosDetalleComponent.prototype.getDetalleConsulta = function () {
        var _this = this;
        console.log('Prestador detalle Ingresa a getDetalleConsulta...');
        this.getDetalle().subscribe(
        // Success response
        function (response) {
            _this.detalleConsulta = response;
            console.log('Trae bien...this.detalleConsulta.length=' + _this.detalleConsulta.length);
            _this.inicializarTablaDetalleServicios();
            _this.setTablaDetalleDatos();
            //Se activan las banderas respectivas para que se muestre el detalle
            _this.concultaService.asignarMostrarDetalle(true);
            _this.concultaService.asignarMostrarDetalleSinResultados(false);
    ...
    // Cargar detalle
    ServiciosDetalleComponent.prototype.getDetalle = function () {
    ...
    // Error petición
    ServiciosDetalleComponent.prototype.errorHandler = function (error) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_6__["throwError"])(error);
    };
    /*
    Función que llena la tabla detalle con las columnas especificadas en el array que pasa por parametro
    param: idsTablaSedesParam = Array definido en esta clase this.idsTablaSedes
    */
    ServiciosDetalleComponent.prototype.setTablaDetalleDatos = function () {
        //Se recorre la lista de objetos
        for (var indexDatos = 0; indexDatos < this.detalleConsulta.length; indexDatos++) {
            var listElements = [];
            var data = Object.keys(this.detalleConsulta[indexDatos]);
            //Se recorre el array de campos para asignarlos en el orden que se requiere
            for (var indexIds = 0; indexIds < this.idsTablaServicios.length; indexIds++) {
                // Se recorre la fila, para obtener el orden especifico que se requiere
                for (var j = 0; j < data.length; j++) {
                    var element = this.detalleConsulta[indexDatos][data[j]];
                    var el = {
    ...
    ServiciosDetalleComponent.ctorParameters = function () { return [
        { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"] },
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] }
    ]; };
    ...
    return ServiciosDetalleComponent;
}());
...
var ServiciosFiltroComponent = /** @class */ (function () {
    function ServiciosFiltroComponent(concultaService, serviciosDetalle) {
        this.concultaService = concultaService;
    ...
    ServiciosFiltroComponent.prototype.inicializarForm = function () {
        this.formGroup = this.formBuilder.group({
            numero_documento: [''],
            naturaleza_juridica: [''],
            grupo: [''],
    ...
    ServiciosFiltroComponent.prototype.buscar = function () {
        var _this = this;
        this.concultaService.invalidRecaptcha = false;
        this.successDownload = false;
        if (this.formGroup.get('recaptcha').value === null) {
    ...
    ServiciosFiltroComponent.prototype.success = function (data) {
        if (data.length > 0) {
            this.concultaService.detalleConsulta = data;
            this.concultaService.setTablaDetalleDatos(this.concultaService.idsTablaSanciones);
            this.concultaService.asignarMostrarDetalle(true);
    ...
    ServiciosFiltroComponent.prototype.limpiar = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    ServiciosFiltroComponent.prototype.descargarResultados = function () {
        var _this = this;
        this.concultaService.getDetalleExcel(this.concultaService.tipoDetalle.servicios).subscribe(function (data) {
            var newBlob = new Blob([data], { type: 'application/vnd.ms-excel' });
            // IE
            if (window.navigator && window.navigator.msSaveOrOpenBlob && _this.concultaService.isIE()) {
                window.navigator.msSaveOrOpenBlob(newBlob);
            ...
            var link = document.createElement('a');
            link.href = downloadURL;
            link.download = 'Consulta de prestadores de salud ' + _this.concultaService.tipoDetalle.servicios + '.xls';
            link.click();
            // Habilita mensaje success
            _this.concultaService.asignarDescargaCompleta(true);
            _this.successDownload = true;
    ...
    ServiciosFiltroComponent.prototype.ngOnInit = function () {
        this.concultaService.asignarMostrarDetalle(false);
        this.concultaService.asignarMostrarDetalleSinResultados(false);
        this.concultaService.asignarDescargaCompleta(false);
        this.concultaService.inicializarFiltro();
    ...
    ServiciosFiltroComponent.prototype.cargarMunicipios = function () {
        this.concultaService.cargarMunicipios(this.formGroup.get('departamento_sede').value.value);
        this.formGroup.get('municipio_sede').setValue(null);
    };
    ServiciosFiltroComponent.ctorParameters = function () { return [
        { type: _services_minsalud_consulta_util_service__WEBPACK_IMPORTED_MODULE_2__["MinsaludConsultaUtilService"] },
    ...
    return ServiciosFiltroComponent;
}());
...
var MinsaludConsultaRoutingModule = /** @class */ (function () {
    function MinsaludConsultaRoutingModule() {
    }
    ...
    return MinsaludConsultaRoutingModule;
}());
...
/* harmony import */ var ng_recaptcha__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ng-recaptcha */ "./node_modules/ng-recaptcha/fesm5/ng-recaptcha.js");
...
var MinsaludConsultaModule = /** @class */ (function () {
    function MinsaludConsultaModule() {
    }
...
var MinsaludConsultaUtilService = /** @class */ (function () {
    function MinsaludConsultaUtilService(router, http, modalService, minsaludModal) {
        var _this = this;
        this.router = router;
        this.http = http;
        this.modalService = modalService;
        ...
        this.getDetail = function (e, item, index) {
            _this.registroSeleccionado = _this.detalleConsulta[item[0].content]; // TODO: Validar la carga de data en la instancia
            _this.minsaludModal.getDetail(item, _this.opcionSeleccionada);
        };
    ...
    MinsaludConsultaUtilService.prototype.getMostrarDetalle = function (name) {
        return this.mostrarDetalle;
    };
    MinsaludConsultaUtilService.prototype.asignarMostrarDetalle = function (mostrarDetalleParam) {
        this.mostrarDetalle = mostrarDetalleParam;
        return this.mostrarDetalle;
    };
    MinsaludConsultaUtilService.prototype.asignarMostrarDetalleSinResultados = function (mostrarDetalleSinResultadosParam) {
        this.mostrarDetalleSinResultados = mostrarDetalleSinResultadosParam;
        return this.mostrarDetalleSinResultados;
    };
    MinsaludConsultaUtilService.prototype.asignarDescargaCompleta = function (descargaCompletaParam) {
        this.descargaCompleta = descargaCompletaParam;
        return this.descargaCompleta;
    };
    MinsaludConsultaUtilService.prototype.cargarListasPrestadores = function () {
    ...
    MinsaludConsultaUtilService.prototype.cargarListasSedes = function () {
        this.getListaNaturalezaJuridica();
        this.getListaDepartamento();
        this.getListaMunicipio();
        this.getListaClasePrestador();
    ...
    MinsaludConsultaUtilService.prototype.cargarListasServicios = function () {
        this.getListaNaturalezaJuridica();
        this.getListaGrupo();
    ...
    MinsaludConsultaUtilService.prototype.cargarListasCapacidad = function () {
        this.getListaNaturalezaJuridica();
        this.getListaGrupo();
    ...
    //   this.getListaCaracterTerritorial();
    // }
    MinsaludConsultaUtilService.prototype.cargarListasSanciones = function () {
        this.getListaNaturalezaJuridica();
        this.getListaGrupo();
        this.getListaNombreServicio();
        this.getListaDepartamento();
    ...
    MinsaludConsultaUtilService.prototype.cargarListas = function () {
        this.getListaNaturalezaJuridica();
        this.getListaCaracterTerritorial();
        this.getListaClasePrestador();
        this.getListaConcepto();
    ...
    MinsaludConsultaUtilService.prototype.getListaNaturalezaJuridica = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.naturalezaJuridica).subscribe(
        // Success response
        function (response) {
            _this.listaNaturalezaJuridica = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaCaracterTerritorial = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.caracterTerritorial).subscribe(
        // Success response
        function (response) {
            _this.listaCaracterTerritorial = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaClasePrestador = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.clasePrestador).subscribe(
        // Success response
        function (response) {
            _this.listaClasePrestador = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaConcepto = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.concepto).subscribe(
        // Success response
        function (response) {
            _this.listaConcepto = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaDepartamento = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.departamento).subscribe(
        // Success response
        function (response) {
            _this.listaDepartamento = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaEmpresaSocialEstado = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.empresaSocialEstado).subscribe(
        // Success response
        function (response) {
            _this.listaEmpresaSocialEstado = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaGrupo = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.grupo).subscribe(
        // Success response
        function (response) {
            _this.listaGrupo = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaMunicipio = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.municipio).subscribe(
        // Success response
        function (response) {
            _this.listaMunicipio = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaNivelAtencionPrestador = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.nivelAtencionPrestador).subscribe(
        // Success response
        function (response) {
            _this.listaNivelAtencionPrestador = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaNombreServicio = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.nombreServicio).subscribe(
        // Success response
        function (response) {
            _this.listaNombreServicio = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaSedePrincipal = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.sedePrincipal).subscribe(
        // Success response
        function (response) {
            _this.listaSedePrincipal = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListaZona = function () {
        var _this = this;
        this.getListas_modificada(this.tipoLista.zona).subscribe(
        // Success response
        function (response) {
            _this.listaZona = response;
        }, 
        // Failure response
        function (error) {
            console.error(error);
    ...
    MinsaludConsultaUtilService.prototype.getListas_modificada = function (tipoListaParam) {
    ...
    MinsaludConsultaUtilService.prototype.getDetalleConsulta = function (tipoDetalleParam, idsTablaSedesParam) {
        var _this = this;
        ...
        function (response) {
            ...
            if (tipoDetalleParam == _this.tipoDetalle.prestadores)
                _this.inicializarTablaDetallePrestadores();
            if (tipoDetalleParam == _this.tipoDetalle.sedes)
                _this.inicializarTablaDetalleSedes();
            if (tipoDetalleParam == _this.tipoDetalle.servicios)
                _this.inicializarTablaDetalleServicios();
            if (tipoDetalleParam == _this.tipoDetalle.capacidad)
                _this.inicializarTablaDetalleCapacidad();
            if (tipoDetalleParam == _this.tipoDetalle.seguridad)
                //this.inicializarTablaDetalleSeguridad();
                _this.inicializarTablaDetalleServicios();
            if (tipoDetalleParam == _this.tipoDetalle.sanciones)
                //this.inicializarTablaDetalleSanciones();
                _this.inicializarTablaDetalleServicios();
            //console.log('Prestadores 3...');
            _this.setTablaDetalleDatos(idsTablaSedesParam);
            //console.log('Prestadores 4...');
            //Se activan las banderas respectivas para que se muestre el detalle
            _this.asignarMostrarDetalle(true);
            //console.log('Prestadores 5...');
            _this.asignarMostrarDetalleSinResultados(false);
            if (_this.detalleConsulta == null || _this.detalleConsulta.length == 0) {
                _this.cantidadRegistrosOtro = _this.detalleConsulta.length;
                _this.asignarMostrarDetalle(false);
                _this.asignarMostrarDetalleSinResultados(true);
            }
        }, 
        // Failure response
        function (error) {
    ...
    MinsaludConsultaUtilService.prototype.isIE = function () {
        var ua = navigator.userAgent;
        var isIe = ua.indexOf('MSIE ') > -1 || ua.indexOf('Trident/') > -1;
        return isIe;
    };
    MinsaludConsultaUtilService.prototype.getDetalleConsultaExcel = function (tipoDetalleParam) {
        var _this = this;
        console.log('llega getDetalleConsultaExcel=...' + tipoDetalleParam);
        this.getDetalleExcel(tipoDetalleParam).subscribe(function (data) {
            window.scroll(0, 0);
            var newBlob = new Blob([data], { type: 'application/vnd.ms-excel' });
            // IE
    ...
    // Cargar detalle
    MinsaludConsultaUtilService.prototype.getDetalle = function (tipoDetalle) {
    ...
    // Generar certificado
    MinsaludConsultaUtilService.prototype.getDetalleExcel = function (tipoDetalle) {
    ...
    // Error petición
    MinsaludConsultaUtilService.prototype.errorHandler = function (error) {
        return Object(rxjs__WEBPACK_IMPORTED_MODULE_4__["throwError"])(error);
    };
    MinsaludConsultaUtilService.prototype.inicializarTablaDetallePrestadores = function () {
        this.tDetail = {
            Header: [
    ...
    MinsaludConsultaUtilService.prototype.inicializarTablaDetalleSedes = function () {
        this.tDetail = {
            Header: [
                { content: 'Id', filter: false, typeFilter: '', hidden: true },
                { content: 'Departamento', filter: false, typeFilter: '' },
    ...
    MinsaludConsultaUtilService.prototype.inicializarTablaDetalleServicios = function () {
        this.tDetail = {
            Header: [
                { content: 'Id', filter: false, typeFilter: '', hidden: true },
                { content: 'Departamento', filter: false, typeFilter: '' },
    ...
    MinsaludConsultaUtilService.prototype.inicializarTablaDetalleCapacidad = function () {
        this.tDetail = {
            Header: [
                { content: 'Id', filter: false, typeFilter: '', hidden: true },
                { content: 'Departamento', filter: false, typeFilter: '' },
    ...
    param: idsTablaSedesParam = Array definido en esta clase this.idsTablaSedes
    */
    MinsaludConsultaUtilService.prototype.setTablaDetalleDatos = function (idsTablaSedesParam) {
        //Se recorre la lista de objetos
        for (var indexDatos = 0; indexDatos < this.detalleConsulta.length; indexDatos++) {
            var listElements = [];
            var data = Object.keys(this.detalleConsulta[indexDatos]);
            //Se recorre el array de campos para asignarlos en el orden que se requiere
            for (var indexIds = 0; indexIds < idsTablaSedesParam.length; indexIds++) {
                // Se recorre la fila, para obtener el orden especifico que se requiere
                for (var j = 0; j < data.length; j++) {
                    var element = this.detalleConsulta[indexDatos][data[j]];
                    var el = {
    ...
    MinsaludConsultaUtilService.prototype.inicializarFiltro = function () {
        this.filtro = this.inicializarFiltroJson("");
        this.listaMunicipioFiltrado = [];
        this.listaMunicipioFiltrado2 = [];
    };
    MinsaludConsultaUtilService.prototype.inicializarFiltroJson = function (historiaParam) {
        var filtroTemp = { historia: "", numero_documento: "", naturaleza_juridica: "", departamento_prestador: "", municipio_prestador: "", codigo_prestador: "", nombre_prestador: "", clase_prestador: "", ese: "", nivel_atencion: "", caracter_territorial: "", departamento_sede: "", municipio_sede: "", codigo_sede: "", sede_principal: "", nombre_sede: "", zona: "", grupo: "", codigo_servicio: "", intramural_ambulatorio: "", intramural_hospitalario: "", extramural_domiciliario: "", extramural_otras: "", extramural_unidad: "", telemedicina_centro: "", telemedicina_institucion: "", complejidad_baja: "", complejidad_media: "", complejidad_alta: "", servicio_nombre: "", concepto: "" };
        filtroTemp.historia = historiaParam;
        return filtroTemp;
    };
    MinsaludConsultaUtilService.prototype.inicializarRegistroSeleccionado = function () {
    ...
    MinsaludConsultaUtilService.prototype.seleccionarHistoria = function (opcionSeleccionadaParam) {
    ...
    MinsaludConsultaUtilService.prototype.cargarMunicipios = function (idDepartamento) {
        this.listaMunicipioFiltrado = [];
        if (idDepartamento != null && idDepartamento != "") {
            for (var index = 0; index < this.listaMunicipio.length; index++) {
    ...
    MinsaludConsultaUtilService.prototype.cargarMunicipios2 = function (idDepartamento) {
        this.listaMunicipioFiltrado2 = [];
        if (idDepartamento != null && idDepartamento != "") {
            for (var index = 0; index < this.listaMunicipio.length; index++) {
                if (this.listaMunicipio[index].value == "" || this.listaMunicipio[index].value.substring(0, 2) == idDepartamento) {
    ...
    MinsaludConsultaUtilService.prototype.backToTop = function () {
        document.body.scrollTop = 0; // For Safari
        document.documentElement.scrollTop = 0; // For Chrome, Firefox, IE and Opera
    };
    MinsaludConsultaUtilService.ctorParameters = function () { return [
    ...
    return MinsaludConsultaUtilService;
}());
...
var MinsaludModalUtilService = /** @class */ (function () {
    function MinsaludModalUtilService(modalService) {
        var _this = this;
        this.modalService = modalService;
        this.componentsType = [
            {
        ...
        // Función general para el evento de abrir modal sobre la tabla detalle
        this.getDetail = function (item, opt) {
            var componentDetail = _this.componentsType.find(function (p) { return p.name === opt; });
            var modal = _this.modalService.open(componentDetail.component, {
                size: 'lg',
                backdrop: 'static',
                keyboard: false,
                centered: true,
    ...
    MinsaludModalUtilService.ctorParameters = function () { return [
    ...
    return MinsaludModalUtilService;
}());
...
//# sourceMappingURL=tramites-minsalud-consulta-minsalud-consulta-module-es5.d184f739c9f2214b9128.js.map