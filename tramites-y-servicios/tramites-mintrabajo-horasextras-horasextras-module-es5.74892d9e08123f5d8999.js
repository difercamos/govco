...
var PrincipalComponent = /** @class */ (function () {
    function PrincipalComponent(router, utils) {
        this.router = router;
        this.utils = utils;
        this.autorizar = true;
    }
    ...
    PrincipalComponent.prototype.continuar = function () {
        this.router.navigate(['/mintrabajo/seleccionar']);
        this.utils.estadoTramite('2');
    };
    PrincipalComponent.prototype.cancelar = function () {
        this.router.navigate(['/mintrabajo/']);
    };
    PrincipalComponent.prototype.autoriza = function () {
...
var SelecciontramiteComponent = /** @class */ (function () {
    function SelecciontramiteComponent(router) {
        this.router = router;
    }
    SelecciontramiteComponent.prototype.ngOnInit = function () {
    };
    SelecciontramiteComponent.prototype.consultar = function () {
        this.router.navigate(['/mintrabajo/consultar']);
    };
    SelecciontramiteComponent.prototype.radicar = function () {
        this.router.navigate(['/mintrabajo/descripcion']);
    };
    SelecciontramiteComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    ...
    return SelecciontramiteComponent;
}());
...
var ConsultaComponent = /** @class */ (function () {
    function ConsultaComponent(utils) {
        this.utils = utils;
    ...
    ConsultaComponent.prototype.RealizarConsulta = function () {
...
var ConsultaForm = /** @class */ (function () {
    ...
    ConsultaForm.prototype.getForm = function () {
        return this.form;
    };
    ConsultaForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    ConsultaForm.prototype.isValid = function () {
...
var ResultadoComponent = /** @class */ (function () {
    ...
    ResultadoComponent.prototype.setTableDetailcData = function () {
        var e_1, _a, e_2, _b;
...
var ConsultatramiteModule = /** @class */ (function () {
    function ConsultatramiteModule() {
    }
...
var HorasextrasModule = /** @class */ (function () {
    function HorasextrasModule() {
    }
...
var HorasExttrasRoutingModule = /** @class */ (function () {
    function HorasExttrasRoutingModule() {
    }
    ...
    return HorasExttrasRoutingModule;
}());
...
var DatosremitenteComponent = /** @class */ (function () {
    function DatosremitenteComponent(modalService, router, utils) {
    ...
    DatosremitenteComponent.prototype.ngOnInit = function () {
        this.seleccionSolucionForm = new _datosremitente_form__WEBPACK_IMPORTED_MODULE_2__["DatosRemitenteForm"]();
        this.seleccionForm = this.seleccionSolucionForm.getForm();
    };
    DatosremitenteComponent.prototype.abrirDireccion = function () {
        var _this = this;
        var modal = this.modalService.open(_direccionmodal_direccionmodal_component__WEBPACK_IMPORTED_MODULE_4__["DireccionmodalComponent"], {
            size: 'lg',
            backdrop: "static",
            keyboard: true
        });
        modal.componentInstance.messageEvent.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.unsubscribe$)).subscribe(function (mensaje) {
            if (mensaje === '%&/$')
                modal.close();
            else {
                _this.direccion = mensaje;
                modal.close();
            }
        });
    };
    DatosremitenteComponent.prototype.eliminarDireccion = function () {
        this.direccion = '';
    };
    DatosremitenteComponent.prototype.atras = function () {
        this.router.navigate(['/mintrabajo/descripcion']);
    };
    DatosremitenteComponent.prototype.cancelar = function () {
        this.router.navigate(['/mintrabajo']);
    };
    DatosremitenteComponent.prototype.continuar = function () {
        if (this.seleccionSolucionForm.isValid()) {
    ...
    DatosremitenteComponent.ctorParameters = function () { return [
    ...
    return DatosremitenteComponent;
}());
...
var DatosRemitenteForm = /** @class */ (function () {
    function DatosRemitenteForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    //
    DatosRemitenteForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
            tipo_persona: ['', [_angular_forms__WEBPACK_IMPORTED_MODULE_0__["Validators"].required]],
            tipo_documento: [''],
        });
    };
    DatosRemitenteForm.prototype.getForm = function () {
        return this.form;
    };
    DatosRemitenteForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    DatosRemitenteForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return DatosRemitenteForm;
}());
...
var DescripciontramiteComponent = /** @class */ (function () {
    function DescripciontramiteComponent(router, utils) {
        this.router = router;
        this.utils = utils;
    ...
    DescripciontramiteComponent.prototype.ngOnInit = function () {
        this.seleccionSolucionForm = new _descripciontramite_form__WEBPACK_IMPORTED_MODULE_3__["DescripciontramiteForm"]();
        this.seleccionForm = this.seleccionSolucionForm.getForm();
        this.utils.estadoTramite('2');
    };
    DescripciontramiteComponent.prototype.AgregarDireccionTerritorial = function () {
    ...
    DescripciontramiteComponent.prototype.EliminarDireccionTerritorial = function () {
        this.direccionTerritorial = '';
        this.seleccionForm.controls['direccion_territorial'].enable();
    };
    DescripciontramiteComponent.prototype.AgregarNumeroRadicado = function () {
    ...
    DescripciontramiteComponent.prototype.EliminarNumeroRadicado = function () {
        this.numero_radicado = '';
        this.seleccionForm.controls['numero_radicado'].enable();
    };
    DescripciontramiteComponent.prototype.MostrarOrganizacionesSindicales = function () {
        this.mostrarOrganizacionesSindicales = this.seleccionForm.value.organizaciones_sindicales.text === 'Si';
    };
    DescripciontramiteComponent.prototype.continuar = function () {
        if (this.seleccionSolucionForm.isValid()) {
    ...
    DescripciontramiteComponent.prototype.cancelar = function () {
        this.router.navigate(['/mintrabajo']);
    };
    DescripciontramiteComponent.prototype.onKeyValidNumber = function () {
        var regEx = new RegExp('[0-9]{2}[A-Z]{2}[0-9]{19}');
        this.formatoRadicadoinvalido = regEx.test(this.seleccionForm.controls.numero_radicado.value);
    };
    DescripciontramiteComponent.ctorParameters = function () { return [
    ...
    return DescripciontramiteComponent;
}());
...
var DescripciontramiteForm = /** @class */ (function () {
    function DescripciontramiteForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    //
    DescripciontramiteForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
    ...
    DescripciontramiteForm.prototype.getForm = function () {
        return this.form;
    };
    DescripciontramiteForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    DescripciontramiteForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return DescripciontramiteForm;
}());
...
var DireccionmodalComponent = /** @class */ (function () {
    function DireccionmodalComponent() {
        this.messageEvent = new _angular_core__WEBPACK_IMPORTED_MODULE_1__["EventEmitter"]();
    }
    DireccionmodalComponent.prototype.ngOnInit = function () {
    };
    DireccionmodalComponent.prototype.sendMessage = function (message) {
        this.messageEvent.emit(message);
    };
    DireccionmodalComponent.prototype.receiveMessage = function ($event) {
    ...
    return DireccionmodalComponent;
}());
...
var DocumentostramiteComponent = /** @class */ (function () {
    function DocumentostramiteComponent(modalService, router, utils) {
        this.modalService = modalService;
        this.router = router;
        this.utils = utils;
    ...
    DocumentostramiteComponent.prototype.ngOnInit = function () {
    ...
    DocumentostramiteComponent.prototype.SeleccionarArchivo = function () {
        var modal = this.modalService.open(src_app_tramites_mintrabajo_sharedmintrabajo_components_subirarchivo_subirarchivo_component__WEBPACK_IMPORTED_MODULE_3__["SubirarchivoComponent"], {
            size: 'lg',
            backdrop: "static",
            keyboard: true
        });
    ...
    DocumentostramiteComponent.prototype.regresar = function () {
        this.router.navigate(['/mintrabajo/remitente']);
    };
    DocumentostramiteComponent.prototype.radicar = function () {
        this.router.navigate(['/mintrabajo/registro']);
        this.utils.estadoTramite('4');
    };
    DocumentostramiteComponent.ctorParameters = function () { return [
    ...
    return DocumentostramiteComponent;
}());
...
var DocumentostramiteForm = /** @class */ (function () {
    function DocumentostramiteForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    //
    DocumentostramiteForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
            recaptcha: [''],
        });
    };
    DocumentostramiteForm.prototype.getForm = function () {
        return this.form;
    };
    DocumentostramiteForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    DocumentostramiteForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return DocumentostramiteForm;
}());
...
var OrganizacionessindicalesComponent = /** @class */ (function () {
    function OrganizacionessindicalesComponent(modalService) {
        this.modalService = modalService;
        this.listOrganizacionesSindicales = [];
        this.invalidForm = false;
        this.unsubscribe$ = new rxjs__WEBPACK_IMPORTED_MODULE_5__["Subject"]();
    }
    OrganizacionessindicalesComponent.prototype.ngOnInit = function () {
        this.seleccionSolucionForm = new _organizacionessindicales_form__WEBPACK_IMPORTED_MODULE_2__["OrganizacionesSindicalesForm"]();
        this.seleccionForm = this.seleccionSolucionForm.getForm();
    };
    OrganizacionessindicalesComponent.prototype.limpiarOrganizacionSindical = function () {
        this.seleccionForm.reset();
        this.invalidForm = false;
    };
    OrganizacionessindicalesComponent.prototype.eliminarOrganizacionSindical = function (d) {
        var index = this.listOrganizacionesSindicales.indexOf(d);
        this.listOrganizacionesSindicales.splice(index, 1);
    };
    OrganizacionessindicalesComponent.prototype.agregarOrganizacionSindical = function () {
        if (this.seleccionSolucionForm.isValid()) {
    ...
    OrganizacionessindicalesComponent.prototype.abrirDireccion = function () {
        var _this = this;
        var modal = this.modalService.open(_direccionmodal_direccionmodal_component__WEBPACK_IMPORTED_MODULE_4__["DireccionmodalComponent"], {
            size: 'lg',
            backdrop: "static",
        ...
        modal.componentInstance.messageEvent.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_6__["takeUntil"])(this.unsubscribe$)).subscribe(function (mensaje) {
            if (mensaje === '%&/$')
                ...
                _this.seleccionForm.controls['direccion'].setValue(mensaje);
                modal.close();
            }
        });
    };
    OrganizacionessindicalesComponent.prototype.ngOnDestroy = function () {
        this.unsubscribe$.next();
        this.unsubscribe$.complete();
    };
    OrganizacionessindicalesComponent.ctorParameters = function () { return [
        { type: _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModal"] }
    ]; };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Output"])()
    ...
    return OrganizacionessindicalesComponent;
}());
...
var OrganizacionesSindicalesForm = /** @class */ (function () {
    function OrganizacionesSindicalesForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    OrganizacionesSindicalesForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
    ...
    OrganizacionesSindicalesForm.prototype.getForm = function () {
        return this.form;
    };
    OrganizacionesSindicalesForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    OrganizacionesSindicalesForm.prototype.isValid = function () {
        return this.form.valid;
    };
    return OrganizacionesSindicalesForm;
}());
...
var TramiteregistradoComponent = /** @class */ (function () {
    function TramiteregistradoComponent(router) {
        this.router = router;
    }
    TramiteregistradoComponent.prototype.ngOnInit = function () {
    };
    TramiteregistradoComponent.prototype.aceptar = function () {
        this.router.navigate(['/mintrabajo']);
    };
    TramiteregistradoComponent.ctorParameters = function () { return [
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
    ]; };
    ...
    return TramiteregistradoComponent;
}());
...
var DireccionComponent = /** @class */ (function () {
    function DireccionComponent(el) {
        this.el = el;
        this.listaSINO = [
            {
                value: 1,
    ...
    DireccionComponent.prototype.obtenerDireccion = function () {
        var _this = this;
        var e_1, _a;
        var cadena = '';
        Object.keys(this.seleccionForm.controls).forEach(function (key) {
            var control = _this.seleccionForm.get(key);
            if (control != null)
        ...
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.complementos), _c = _b.next(); !_c.done; _c = _b.next()) {
                var c = _c.value;
    ...
    DireccionComponent.prototype.enviarDireccion = function () {
        if (this.seleccionSolucionForm.isValid())
    ...
    DireccionComponent.prototype.agregarComplemento = function () {
    ...
    DireccionComponent.prototype.limpiarControl = function (nombre) {
        this.seleccionForm.controls[nombre].setValue('');
    };
    DireccionComponent.prototype.cancelar = function () {
        this.messageEvent.emit('%&/$');
    };
    DireccionComponent.prototype.habilitarControlesXpais = function () {
    ...
    DireccionComponent.prototype.EliminarComplemento = function (fila) {
        var index = this.complementos.indexOf(fila);
        this.complementos.splice(index, 1);
    };
    DireccionComponent.prototype.scrollAlControlInvalido_modal = function () {
        var firstInvalidControl = this.el.nativeElement.querySelector(".ng-invalid");
        if (firstInvalidControl) {
            firstInvalidControl.scrollIntoView({ behavior: 'smooth', block: 'center' });
        }
    };
    DireccionComponent.ctorParameters = function () { return [
...
var DireccionForm = /** @class */ (function () {
    function DireccionForm() {
        this.formBuilder = new _angular_forms__WEBPACK_IMPORTED_MODULE_0__["FormBuilder"]();
        this.buildForm();
    }
    DireccionForm.prototype.buildForm = function () {
        this.form = this.formBuilder.group({
    ...
    DireccionForm.prototype.getForm = function () {
        return this.form;
    };
    DireccionForm.prototype.getFormValues = function () {
        return this.form.value;
    };
    DireccionForm.prototype.isValid = function () {
        return this.form.valid;
    };
...
var SubirarchivoComponent = /** @class */ (function () {
    function SubirarchivoComponent() {
    }
    SubirarchivoComponent.prototype.ngOnInit = function () {
    };
    SubirarchivoComponent.prototype.SeleccionarArchivo = function (event) {
        this.selectFile = event.target.files[0];
    };
    SubirarchivoComponent.prototype.CargarArchivo = function () {
...
var UtilsService = /** @class */ (function () {
    ...
    UtilsService.prototype.scrollControInvalido = function () {
        var firstElementWithError = document.querySelector('.ng-invalid[formControlName]');
        if (firstElementWithError) {
            firstElementWithError.scrollIntoView({ behavior: 'smooth', block: 'center' });
        }
    };
    UtilsService.prototype.estadoTramite = function (paso) {
...
//# sourceMappingURL=tramites-mintrabajo-horasextras-horasextras-module-es5.74892d9e08123f5d8999.js.map