...
let ApostillaComponent = class ApostillaComponent {
    constructor() { }
    ngOnInit() {
        this.getMessages();
    }
...
let LicenciaConduccionComponent = class LicenciaConduccionComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
class SolicitarCertificadoForm {
    constructor() {
...
let SolicitarCertificadoComponent = class SolicitarCertificadoComponent {
    constructor(dialog, mintrabajoService, recaptchaService) {
        this.dialog = dialog;
    ...
    getEntidades() {
        this.mintrabajoService.getEntidades().subscribe((data) => {
    ...
    getPaises() {
        this.mintrabajoService.getPaises().subscribe((data) => {
            if (data != undefined && data.success === true) {
    ...
    getTiposDocumento() {
        this.mintrabajoService.getTiposDocumento().subscribe((data) => {
            if (data != undefined && data.success === true) {
    ...
    changeEntidad() {
        this.solicitudForm.get('tipoEntidadDestino').valueChanges.subscribe((tipoEntidad) => {
    ...
    sendData(formData) {
        ...
        this.mintrabajoService.postSolicitud(valores).subscribe((data) => {
...
SolicitarCertificadoComponent.ctorParameters = () => [
...
let LicenciaConduccionRoutingModule = class LicenciaConduccionRoutingModule {
};
...
let LicenciaConduccionModule = class LicenciaConduccionModule {
};
...
class LicenciaConduccionService {
    constructor(http) {
        this.http = http;
...
LicenciaConduccionService.ctorParameters = () => [
...
//# sourceMappingURL=tramites-mintransporte-licencia-conduccion-licencia-conduccion-module-es2015.3bc864db6ed09f65d213.js.map