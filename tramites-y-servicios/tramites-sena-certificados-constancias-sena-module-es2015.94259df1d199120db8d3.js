...
let CertificadoConstanciaListComponent = class CertificadoConstanciaListComponent {
    constructor(senaUtils, router) {
...
CertificadoConstanciaListComponent.ctorParameters = () => [
...
let CertificadoConstanciaComponent = class CertificadoConstanciaComponent {
    constructor(senaUtils, router, fb) {
        this.senaUtils = senaUtils;
        this.router = router;
        this.fb = fb;
...
CertificadoConstanciaComponent.ctorParameters = () => [
...
let SenaComponent = class SenaComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let SenaRoutingModule = class SenaRoutingModule {
};
...
let SenaModule = class SenaModule {
};
...
let SenaUtilsService = class SenaUtilsService {
    constructor(http) {
        this.http = http;
        this.urlTramite = {
    ...
    consultarCertificadosCosntancias(datosSolicitante) {
    ...
    setDatosSolicitante(datosSolicitante) {
        this.datosSolicitante = datosSolicitante;
    }
    getDatosSolicitante() {
        return this.datosSolicitante;
    }
    setListCertificadosConstancias(certificadosConstancias) {
        this.certificadosConstancias = certificadosConstancias;
    }
    getListCertificadosConstancias() {
...
SenaUtilsService.ctorParameters = () => [
...
//# sourceMappingURL=tramites-sena-certificados-constancias-sena-module-es2015.94259df1d199120db8d3.js.map